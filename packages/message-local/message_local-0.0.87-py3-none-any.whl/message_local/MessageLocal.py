...
class MessageLocal(Item, CompoundMessage):
    """Message Local Class"""
    ...
    def __init__(self, *, recipients: List[Recipient], api_type_id: int = None, campaign_id: int = None,
        ...
        logger.start()
        super().__init__(message_id=message_id, campaign_id=campaign_id,
    ...
    def get_body_after_text_template(self, recipient: Recipient = None,
        ...
        body = ""
        for block in self.get_compound_message_dict(message_channel)[message_channel.name]:
