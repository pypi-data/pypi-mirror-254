...
class EloSystem:
    ...
    def add_player(self, name: str, elo: int | None = None) -> None:
        if elo is None:
            elo = self.base_elo
    ...
    def set_elo(self, name: str, elo: int) -> None:
        self.players[name].elo = elo

    def add_elo(self, name: str, elo: int) -> None:
        self.players[name].elo += elo

    def remove_elo(self, name: str, elo: int) -> None:
        self.players[name].elo -= elo

    def reset_elo(self, name: str) -> None:
        self.players[name].elo = self.base_elo

    # Return Methods

    def get_player_elo(self, name: str) -> int:
        return self.players[name].elo

    def get_player_wins(self, name: str) -> int:
        return self.players[name].wins

    def get_player_losses(self, name: str) -> int:
        return self.players[name].losses

    def get_player_draws(self, name: str) -> int:
