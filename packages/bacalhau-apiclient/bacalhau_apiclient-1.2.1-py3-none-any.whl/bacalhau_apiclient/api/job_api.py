...
class JobApi(object):
    ...
    def cancel(self, body, **kwargs):  # noqa: E501
        ...
        :param LegacyCancelRequest body: (required)
        :return: LegacyCancelResponse
    ...
    def cancel_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LegacyCancelResponse',  # noqa: E501
    ...
    def events(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param LegacyEventsRequest body: Request must specify a `client_id`. To retrieve your `client_id`, you can do the following: (1) submit a dummy job to Bacalhau (or use one you created before), (2) run `bacalhau describe <job-id>` and fetch the `ClientID` field. (required)
        :return: LegacyEventsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def events_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LegacyEventsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param LegacyListRequest body: Set `return_all` to `true` to return all jobs on the network (may degrade performance, use with care!). (required)
    ...
    def list_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LegacyListResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def logs(self, body, **kwargs):  # noqa: E501
        ...
        Shows the output from the job specified by `id` as long as that job belongs to `client_id`. The output will be continuous until either, the client disconnects or the execution completes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param LegacyLogRequest body: (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def results(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param LegacyStateRequest body: (required)
        :return: LegacyResultsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def results_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LegacyResultsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def states_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LegacyStateResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def submit(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param LegacySubmitRequest body: (required)
    ...
    def submit_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LegacySubmitResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
