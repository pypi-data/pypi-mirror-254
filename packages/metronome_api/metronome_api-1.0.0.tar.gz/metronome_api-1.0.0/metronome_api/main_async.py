...
class AsyncClient:
    ...
    async def delete_billing_config_for_customer(
        self,
        *,
        customer_id: str,
    ...
    async def get_customer(self, *, customer_id: str) -> GetCustomersCustomerIdResponse:
        """
    ...
    async def get_plan_price_adjustments(
        self,
        *,
        customer_id: str,
    ...
    async def get_plan_details(self, *, plan_id: str) -> GetPlanDetailsPlanIdResponse:
        """
    ...
    async def add_custom_field_key(
    ...
    async def delete_custom_fields(
    ...
    async def disable_custom_field_key(
    ...
    async def set_billing_config_for_customer(
        self,
        *,
