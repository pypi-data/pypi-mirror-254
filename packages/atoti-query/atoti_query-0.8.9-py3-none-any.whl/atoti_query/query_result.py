...
class QueryResult(pd.DataFrame):
    ...
    def _repr_html_(self) -> Optional[str]:  # type: ignore[misc] # pyright: ignore[reportGeneralTypeIssues]
        html = (
            self._atoti_metadata.formatted_values._repr_html_()  # type: ignore[operator] # pyright: ignore[reportGeneralTypeIssues]
            if self._atoti_metadata
            else super()._repr_html_()  # type: ignore[misc] # pyright: ignore[reportGeneralTypeIssues]
        )
    ...
    def _repr_latex_(self) -> Optional[str]:  # type: ignore[misc]  # pyright: ignore[reportGeneralTypeIssues]
        latex = (
            self._atoti_metadata.formatted_values._repr_latex_()  # type: ignore[operator] # pyright: ignore[reportGeneralTypeIssues]
            if self._atoti_metadata
            else super()._repr_latex_()  # type: ignore[misc] # pyright: ignore[reportGeneralTypeIssues]
        )
