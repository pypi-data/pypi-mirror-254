...
__all__ = ['pathlike', 'sig', 'param', 'ichain', 'iprod', 'ziplong', 'dict_keys', 'dict_values', 'dict_items', 'moduletype',
           ...
           'nparray', 'recarray', 'npempty', 'sparray', 'spmatrix', 'splinalg', 'speigs', 'sppdist', 'cscarry',
           ...
           'pttensorbase', 'pttensor', 'ptinttensor', 'ptbooltensor', 'ptfloattensor', 'ptdatasets', 'pttransforms',
...
cscarry = matr('scipy.sparse', 'csc_array')
...
# %% ../nbs/01_inst.ipynb 51
anndata = matr('anndata', 'AnnData')
'''`anndata.AnnData`''';

# %% ../nbs/01_inst.ipynb 53
...
# %% ../nbs/01_inst.ipynb 63
sns = matr('seaborn')
'''`seaborn`''';

# %% ../nbs/01_inst.ipynb 65
...
# %% ../nbs/01_inst.ipynb 67
PHATE = matr('phate', 'PHATE', bases=(skestimator, ))
'''`phate.PHATE`''';

# %% ../nbs/01_inst.ipynb 69
