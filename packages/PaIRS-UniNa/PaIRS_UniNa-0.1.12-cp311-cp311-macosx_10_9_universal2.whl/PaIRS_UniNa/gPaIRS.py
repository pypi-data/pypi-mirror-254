...
class gPaIRS(QMainWindow):
    ...
    def setupCallbacks(self):
        ...
        self.ui.actionChanges.triggered.connect(lambda: changes(self,Log_Tab,fileChanges))
...
#********************************************* Selection of items
    ...
    def setTREpar(self):
        ...
        data:dataTreePar=self.w_Tree.TABpar_prev[idata.indTree][idata.indItem][self.w_Tree.TABpar.ind] #!!!GP idata.ind?
