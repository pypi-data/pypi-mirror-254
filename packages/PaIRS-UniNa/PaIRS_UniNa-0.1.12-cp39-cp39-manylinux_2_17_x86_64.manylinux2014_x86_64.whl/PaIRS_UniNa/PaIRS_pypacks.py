...
if hex(uuid.getnode())=='0x7824af430781': #gerardo windows
    basefold_DEBUG='C:/desk/PIV_Img/img1/'
    basefold_DEBUGOptions=[
                            'C:/desk/PIV_Img/img1/',
                            'C:/desk/PIV_Img/swirler_png/',                            
                            '../../img/calib/',
                            'C:/Desktop/Calibrazione PIV/RBC_sample_cases/2018.09.13/calib_geom/',
                            ]
elif hex(uuid.getnode())=='0xa275dd445ab1': #gerardo mac
    basefold_DEBUG='/Users/gerardo/Desktop/img/img1/'
    basefold_DEBUGOptions=[
                            '/Users/gerardo/Desktop/img/img1/',
                            '/Users/gerardo/Desktop/PIV_Img/swirler_png/',  
                            '/Users/gerardo/Desktop/PIV/img/calib/',                          
                            '../../img/calib/',
                            'C:/Desktop/Calibrazione PIV/RBC_sample_cases/2018.09.13/calib_geom/',
                            ]
...
def whatsNew(self):
    ...
    try:
        ...
        star='<span style="font-size:100%;color:yellow;">⭐</span>'  #⭐,&#9733;
        news='<br/><br/>'.join([star+'   '+c for c in splittedContent])
        Message='<span style=" font-size: 16pt; font-weight:600;">'+f"What's new in PaIRS-UniNa {__version__}"+'</span><br/><br/>'+news+'<br/><br/>Go to the menu "? -> Changes" for further information.'
