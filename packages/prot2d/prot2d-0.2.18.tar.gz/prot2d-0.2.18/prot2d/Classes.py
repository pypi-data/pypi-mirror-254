...
class Protein:
    ...
    def add_hull(self,svg_plane,color, opacity,smoothness=0.1, add_sf =True):
        ...
        if add_sf:
            ...
            svg_plane.add(svgwrite.text.Text(self.sf, insert=(center_x, max_y + 100),fill='black', font_size='80'))  # Verschiebung von 20 Einheiten nach unten
