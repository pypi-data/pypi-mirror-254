...
class CreatePeerDomain(BaseModel):
    ...
    display_name_for_parent: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="The default display name used for this domain. THe display name is also treated as a nickname and so can be used from domainFromNickname. ", alias="displayNameForParent")
    display_name_for_child: Annotated[str, Field(min_length=1, strict=True, max_length=64)] = Field(description="The default display name used for this domain. THe display name is also treated as a nickname and so can be used from domainFromNickname. ", alias="displayNameForChild")
