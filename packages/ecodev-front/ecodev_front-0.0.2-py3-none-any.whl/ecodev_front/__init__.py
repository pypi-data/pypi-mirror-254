...
from ecodev_front.footer import footer
...
from ecodev_front.secure_page_wrapper import generic_page
from ecodev_front.secure_page_wrapper import safe_get_user
