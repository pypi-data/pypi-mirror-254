...
from diTTS.lang import _fallback_deprecated_lang, tts_langs
from diTTS.tokenizer import Tokenizer, pre_processors, tokenizer_cases
from diTTS.utils import _clean_tokens, _minimize, _translate_url

__all__ = ["diTTS", "diTTSError"]
...
class diTTS:
    ...
    def stream(self):
        ...
        Raises:
            :class:`diTTSError`: When there's an error with the API request.
        ...
        for idx, pr in enumerate(prepared_requests):
            try:
                ...
                log.debug(str(e))
                raise diTTSError(tts=self, response=r)
            except requests.exceptions.RequestException as e:  # pragma: no cover
                # Request failed
                log.debug(str(e))
                raise diTTSError(tts=self)
...
class diTTSError(Exception):
    ...
    def __init__(self, msg=None, **kwargs):
        ...
        if msg:
            ...
            self.msg = None
        super(diTTSError, self).__init__(self.msg)
