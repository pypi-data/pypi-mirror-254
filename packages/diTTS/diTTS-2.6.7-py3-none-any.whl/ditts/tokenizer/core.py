...
class PreProcessorRegex:
    ...
    :class:`diTTS.tokenizer.core.RegexBuilder` with an extra ``repl``
    ...
    See :mod:`diTTS.tokenizer.pre_processors` for more examples.
...
class PreProcessorSub:
    ...
    It abstracts :class:`diTTS.tokenizer.core.PreProcessorRegex` with a default
...
class Tokenizer:
    ...
    :class:`diTTS.tokenizer.core.RegexBuilder` instance (and its ``regex``
    attribute).

    See the :mod:`diTTS.tokenizer.tokenizer_cases` module for examples.
