...
class Email:
    ...
    def __init__(self, receiver=None):
        ...
        self.username = '**@163.com'  # 发件人地址
        self.password = "your authorization code "  # 授权码

        self.subject = '自动化测试报告'  # 邮件主题
        self.sender = '**@163.com'  # 发件人
    ...
    def bedeck_report_html(self, data: dict):
        ...
        """
        report_url = data.get("url", "http://localhost:7021/")
        ...
        message = f"""
                    <table border="1px" width="330" align="center" cellspacing="0">
                        ...
                        <tr align="center">
                            <td>维度统计</td>
                            <td><a href="{report_url}" style="text-decoration:none">详情(点击查看)</a></td>
                        </tr>
                        <tr align="center">
                            <td>用例总数</td>
                            <td><b>{total}</b></td>
