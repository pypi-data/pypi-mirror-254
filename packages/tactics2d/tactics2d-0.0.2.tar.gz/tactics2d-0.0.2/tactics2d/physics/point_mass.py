...
class PointMass(PhysicsModelBase):
    ...
    Attributes:
        ...
        delta_t (int): The discrete time step for the simulation. The unit is millisecond. Defaults to `DELTA_T`(5 ms). The expected value is between `MIN_DELTA_T`(1 ms) and `interval`. It is recommended to keep delta_t smaller than 5 ms.
