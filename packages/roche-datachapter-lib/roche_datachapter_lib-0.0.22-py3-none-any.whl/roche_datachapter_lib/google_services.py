...
class GoogleServices():
    ...
    @classmethod
    def update_spreadsheet_values(cls, spreadsheet_id: str, range_name: str, values: List[List[Any]], value_input_option: ValueInputOption = ValueInputOption.RAW) -> int:
    ...
    def write_gsheet_data(cls, spreadsheet_id: str, range_name: str, values_as_df: pd.DataFrame = pd.DataFrame()) -> int:
        ...
        values = values_as_df.values.tolist()
        return cls.update_spreadsheet_values(spreadsheet_id, range_name, values, ValueInputOption.USER_ENTERED)
