...
https://github.com/allenai/allennlp/blob/main/allennlp/data/instance.py
"""

from typing import Dict, MutableMapping, Mapping, Any
from combo.data.vocabulary import Vocabulary
from combo.data.fields import Field
from combo.data.fields.field import DataArray
