...
def fragments_to_cutsite_zarr(
    ...
    chrom_offset_table["global_start"] = chrom_offset_table["global_end"] - chrom_offset_table.iloc[0, 1]
...
def adata_cutsites_to_zarr(adata_path, output_zarr_path, chunk_size=20000000):
    """
