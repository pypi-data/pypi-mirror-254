...
from fastapi_services.descriptor import ServiceDescriptor
from fastapi_services.exc import ArgumentNullException, ServiceIsNotRegistered
from fastapi_services.interfaces import IServiceCollection, IServiceProvider
...
class ServiceCollection(IServiceCollection, IServiceProvider):
    ...
    def mount(self, app):
        app.dependency_overrides.update({k: v for k, v in self.items()})
