...
class ServeModelServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ServeModelServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        'ServeModel', rpc_method_handlers)
...
class ServeModel(object):
    ...
    def Predict(request,
                ...
                timeout=None,
                metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ServeModel/Predict',
