...
class SuperScraper:
    ...
    def __init__(self, browser: Browser = Browser.CHROME,
        ...
        self.driver = None
        self.parser = None
        self.__setup_driver(browser, options, driver_options)
        atexit.register(self.close)

    def __setup_driver(self, browser: Browser, options: ScraperOptions, driver_options = None):
        driver_getter = DriverMagic(options, driver_options)
