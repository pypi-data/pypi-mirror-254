...
class windowswireguard:
    ...
    def add_device(self):
        try:
            if ob.getsess() is not None and is_admin():
                ...
                print("[bold red]:Prohibited: Login and Run the Command promt / Terminal as admin [/bold red]")
        except PermissionError:
            print("[bold red]:Prohibited: Login and Run the Command promt / Terminal as admin ")
        except KeyboardInterrupt:
    ...
    def wgconnect(self):
        if ob.getkey() is not None and is_admin():
            ...
            unabletolog = [
                "[bold red]:Prohibited: Login and Run the Command promt / Terminal as admin ",
            ]
    ...
    def newconfigure(self):
        try:
            ...
            print(":small_blue_diamond:[bold green1] Close the GUI APP and login [/bold green1]")
            self.generatekeys()
        except subprocess.CalledProcessError as e:
            print(f"Error{e}")
    def showinfo(self):
