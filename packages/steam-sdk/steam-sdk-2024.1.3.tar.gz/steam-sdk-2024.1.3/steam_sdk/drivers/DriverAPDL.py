...
class DriverAPDL:
    ...
    def __init__(self, ANSYS_path: str, input_file: str, output_file: str, directory: str,
        ...
        :param jobname: Name of the APDL job
    ...
    def run(self, verbose: bool = None):
        ...
        Run the APDL model
        :param verbose: If True, print some logging information
        :return: Number of errors in the APDL calculation
        '''
        if verbose == None:
        ...
        if verbose:
            print(f'DriverAPDL - Call string:\n{callString}')

        # Run
        call(callString, shell=False)
        if verbose:
            print(f'DriverAPDL - Run finished for the called string:\n{callString}')
