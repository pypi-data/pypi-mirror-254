...
"""
    ...
    def test_ParserRoxie_writeCadataFile(self):
        ...
        '''
        # Arrange
        make_folder_if_not_existing(os.path.join('output', 'write_cadata_file'), verbose=True)
        path_input_cadata_file = os.path.join('input', 'write_cadata_file', 'TEST_INPUT_CADATA_FILE.cadata')
        path_written_cadata_file = os.path.join('output', 'write_cadata_file', 'TEST_OUTPUT_CADATA_FILE.cadata')
