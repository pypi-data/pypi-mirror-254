...
class TestParserLEDET(unittest.TestCase):
    ...
    def test_write2Excel_withoutConsistencyCheck(self):
        # arrange
        file_name = os.path.join('output', 'MQXF_V2_TEST.xlsx')
        builder_ledet = BuilderLEDET(flag_build=False)

        # act
        pl = ParserLEDET(builder_ledet)
        pl.writeLedet2Excel(file_name, verbose=True, SkipConsistencyCheck=True)
    ...
    def test_copy_map2d(self):
        ...
        values_REFERENCE = parseRoxieMap2d(map2d_file_name, headerLines=1)
        values_GENERATED = parseRoxieMap2d(map2d_file_name_GENERATED, headerLines=1)
    ...
    def test_copy_modified_map2d_ribbon_cable(self):
        ...
        # checks correct content
        values_REFERENCE = parseRoxieMap2d(map2d_file_name_REFERENCE, headerLines=1)
        values_GENERATED = parseRoxieMap2d(map2d_file_name_GENERATED, headerLines=1)
        np.testing.assert_allclose(values_GENERATED, values_REFERENCE, rtol=1e-5, atol=0)
