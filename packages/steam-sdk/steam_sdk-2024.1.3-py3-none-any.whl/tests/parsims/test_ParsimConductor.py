...
from steam_sdk.data.DataParsimConductor import Magnet, ConductorSample, Coil, DataParsimConductor, IcMeasurement, \
    GeneralParameters, StrandGeometry
...
class TestParsimConductor(unittest.TestCase):
    ...
    def test_ParsimConductor_readInput_writeOutput1(self):
        ...
        correct_data_parsim_conductor = DataParsimConductor(
            GeneralParameters=GeneralParameters(magnet_name='TEST_MAG_NAME', circuit_name=None, state=None),
            Magnet=Magnet(coils=['CUDI1_1_meas_coil', 'CUDI1_no_meas_coil', 'CUDI1_2_meas_coil', 'Summers_test_coil1',
                ...
                'CUDI1_1_meas_coil': Coil(ID=None, cable_ID=None, coil_resistance_room_T=0.6831,
                        ...
                        ConductorSample(ID=None, Ra=10.0, Rc=None, number_of_strands=36.0, width=0.0151, height=None,
                ...
                'CUDI1_no_meas_coil': Coil(ID=None, cable_ID=None, coil_resistance_room_T=0.6824,
                                           ...
                                           conductorSamples=[
                                               ConductorSample(ID=None, Ra=None, Rc=11.0, number_of_strands=None,
                                                               width=0.0152, height=None, strand_twist_pitch=None,
                ...
                'CUDI1_2_meas_coil': Coil(ID=None, cable_ID=None, coil_resistance_room_T=0.6824,
                                          ...
                                          T_ref_coil_resistance=293.04999999999995, T_ref_RRR_low=None,
                                          T_ref_RRR_high=None, conductorSamples=[
                        ConductorSample(ID=None, Ra=None, Rc=None, number_of_strands=36.0, width=0.0152, height=None,
                ...
                'Summers_test_coil1': Coil(ID=None, cable_ID=None, coil_resistance_room_T=0.6815,
                                           ...
                                           T_ref_coil_resistance=293.04999999999995, T_ref_RRR_low=None,
                                           T_ref_RRR_high=None, conductorSamples=[
                        ConductorSample(ID=None, Ra=None, Rc=None, number_of_strands=36.0, width=0.015, height=None,
                ...
                'Summers_test_coil2': Coil(ID=None, cable_ID=None, coil_resistance_room_T=0.6819,
                                           ...
                                           T_ref_coil_resistance=293.04999999999995, T_ref_RRR_low=None,
                                           T_ref_RRR_high=None, conductorSamples=[
                        ConductorSample(ID=None, Ra=None, Rc=None, number_of_strands=36.0, width=0.0151, height=None,
