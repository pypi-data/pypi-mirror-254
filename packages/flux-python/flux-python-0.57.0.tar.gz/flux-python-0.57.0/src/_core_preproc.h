...
# 395 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 469 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 524 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 568 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 602 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 626 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 674 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 700 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 715 "/__w/flux-python/flux-python/src/_core_clean.h"
const void *flux_buffer_peek (flux_buffer_t *fb, int len, int *lenp);
# 725 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 801 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 913 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 998 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1037 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1114 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1177 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1198 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_msglist_pollevents (struct flux_msglist *l);
int flux_msglist_pollfd (struct flux_msglist *l);
# 1234 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_msg_t *flux_request_encode_raw (const char *topic,
                                     const void *data, int len);
# 1300 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_response_decode (const flux_msg_t *msg,
                          const char **topic,
                          const char **s);
# 1312 "/__w/flux-python/flux-python/src/_core_clean.h"
...
void flux_llog (void *arg,
                ...
                const char *fmt,
                va_list ap);
# 1535 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_future_fulfill_next (flux_future_t *prev,
                              void *result,
                              flux_free_f free_fn);
# 1655 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1733 "/__w/flux-python/flux-python/src/_core_clean.h"
enum event_flags {
...
# 1844 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1917 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1969 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2007 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_conf_unpack (const flux_conf_t *conf,
                      flux_error_t *error,
                      const char *fmt, ...);
# 2091 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_barrier (flux_t *h, const char *name, int nprocs);
# 2134 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_register (flux_t *h, const char *name);
# 2146 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_unregister (flux_t *h, const char *name);
# 2198 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2236 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
int flux_plugin_arg_vunpack (flux_plugin_arg_t *args, int flags,
                             const char *fmt, va_list ap);
# 2392 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_call (flux_plugin_t *p, const char *name,
                      flux_plugin_arg_t *args);
# 2402 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_load_dso (flux_plugin_t *p, const char *path);
# 2435 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_msglist_cancel (flux_t *h,
                         ...
                         const flux_msg_t *msg);
# 2536 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2619 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct flux_kvsdir flux_kvsdir_t;
typedef struct flux_kvsitr flux_kvsitr_t;
# 2634 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2707 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2757 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_getroot (flux_t *h, const char *ns, int flags);
# 2766 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2936 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_copy (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2953 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_move (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2976 "/__w/flux-python/flux-python/src/_core_clean.h"
enum kvs_op {
    FLUX_KVS_READDIR = 1,
    FLUX_KVS_READLINK = 2,
    FLUX_KVS_WATCH = 4,
...
# 2997 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3044 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3118 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_id_encode (flux_jobid_t id, const char *type,
                        char *buf, size_t bufsz);
# 3129 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_job_result_get (flux_future_t *f,
                         const char **json_str);
# 3260 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_result_get_unpack (flux_future_t *f, const char *fmt, ...);
# 3274 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_timeleft (flux_t *h, flux_error_t *errp, double *timeleft);
# 3290 "/__w/flux-python/flux-python/src/_core_clean.h"
char *flux_unwrap_string (const char *in,
                          bool verify,
                          uint32_t *userid,
                          flux_error_t *error);
# 3318 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_jobspec1_t *flux_jobspec1_decode (const char *s,
                                       flux_jobspec1_error_t *error);
# 3429 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3491 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef enum {
...
# 3584 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_subprocess_t *flux_rexec_ex (flux_t *h,
                                  ...
                                  subprocess_log_f log_fn,
                                  void *log_data);
# 3782 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3816 "/__w/flux-python/flux-python/src/_core_clean.h"
const char *flux_subprocess_read (flux_subprocess_t *p,
                                  const char *stream,
                                  int len, int *lenp);
# 3831 "/__w/flux-python/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read_trimmed_line (flux_subprocess_t *p,
                                               const char *stream,
                                               int *lenp);
# 3851 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_subprocess_read_stream_closed (flux_subprocess_t *p,
                                        const char *stream);
# 3870 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3897 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3971 "/__w/flux-python/flux-python/src/_core_clean.h"
