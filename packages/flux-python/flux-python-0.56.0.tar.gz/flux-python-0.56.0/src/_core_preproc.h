...
# 2932 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_copy (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2949 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2993 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3040 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3114 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3270 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_timeleft (flux_t *h, flux_error_t *errp, double *timeleft);
# 3286 "/__w/flux-python/flux-python/src/_core_clean.h"
char *flux_unwrap_string (const char *in,
                          bool verify,
                          uint32_t *userid,
                          flux_error_t *error);
# 3314 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_jobspec1_t *flux_jobspec1_decode (const char *s,
                                       flux_jobspec1_error_t *error);
# 3425 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3487 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef enum {
...
typedef void (*subprocess_log_f) (void *arg,
                                  ...
                                  const char *fmt,
                                  va_list args);
# 3571 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3667 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3740 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_subprocess_t *flux_rexec_ex (flux_t *h,
                                  ...
                                  subprocess_log_f log_fn,
                                  void *log_data);
# 3775 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3806 "/__w/flux-python/flux-python/src/_core_clean.h"
const char *flux_subprocess_read (flux_subprocess_t *p,
                                  const char *stream,
                                  int len, int *lenp);
# 3821 "/__w/flux-python/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read_trimmed_line (flux_subprocess_t *p,
                                               const char *stream,
                                               int *lenp);
# 3841 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_subprocess_read_stream_closed (flux_subprocess_t *p,
                                        const char *stream);
# 3860 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3887 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3961 "/__w/flux-python/flux-python/src/_core_clean.h"
