...
# 1959 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1997 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2124 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_register (flux_t *h, const char *name);
# 2136 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_unregister (flux_t *h, const char *name);
# 2188 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2226 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 2313 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_plugin_arg_vunpack (flux_plugin_arg_t *args, int flags,
                             const char *fmt, va_list ap);
# 2382 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2425 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_sync_create (flux_t *h, double minimum);
# 2457 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2624 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2747 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_getroot (flux_t *h, const char *ns, int flags);
# 2756 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_kvs_txn_symlink (flux_kvs_txn_t *txn, int flags,
                          ...
                          const char *target);
# 2866 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2922 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_copy (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2939 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_move (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2962 "/__w/flux-python/flux-python/src/_core_clean.h"
enum kvs_op {
    FLUX_KVS_READDIR = 1,
    FLUX_KVS_READLINK = 2,
    FLUX_KVS_WATCH = 4,
...
# 2983 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3030 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3104 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_id_encode (flux_jobid_t id, const char *type,
                        char *buf, size_t bufsz);
# 3115 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_job_result_get (flux_future_t *f,
                         const char **json_str);
# 3246 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3276 "/__w/flux-python/flux-python/src/_core_clean.h"
char *flux_unwrap_string (const char *in,
                          bool verify,
                          uint32_t *userid,
                          flux_error_t *error);
# 3304 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_jobspec1_t *flux_jobspec1_decode (const char *s,
                                       flux_jobspec1_error_t *error);
# 3415 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3457 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3477 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef enum {
...
typedef void (*subprocess_log_f) (void *arg,
                                  ...
                                  const char *fmt,
                                  va_list args);
# 3561 "/__w/flux-python/flux-python/src/_core_clean.h"
void flux_standard_output (flux_subprocess_t *p, const char *stream);
# 3570 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_subprocess_t *flux_rexec_ex (flux_t *h,
                                  ...
                                  subprocess_log_f log_fn,
                                  void *log_data);
# 3765 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3796 "/__w/flux-python/flux-python/src/_core_clean.h"
const char *flux_subprocess_read (flux_subprocess_t *p,
                                  const char *stream,
                                  int len, int *lenp);
# 3811 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_subprocess_read_stream_closed (flux_subprocess_t *p,
                                        const char *stream);
# 3850 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3877 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3951 "/__w/flux-python/flux-python/src/_core_clean.h"
