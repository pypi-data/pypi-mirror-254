...
# 566 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 693 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 708 "/__w/flux-python/flux-python/src/_core_clean.h"
const void *flux_buffer_peek (flux_buffer_t *fb, int len, int *lenp);
# 718 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 794 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 906 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 991 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1158 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1179 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_msglist_pollevents (struct flux_msglist *l);
int flux_msglist_pollfd (struct flux_msglist *l);
# 1215 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_msg_t *flux_request_encode_raw (const char *topic,
                                     const void *data, int len);
# 1281 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_response_decode (const flux_msg_t *msg, const char **topic,
                          const char **s);
# 1292 "/__w/flux-python/flux-python/src/_core_clean.h"
...
void flux_llog (void *arg,
                ...
                const char *fmt,
                va_list ap);
# 1505 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1583 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_future_fulfill_next (flux_future_t *prev,
                              void *result,
                              flux_free_f free_fn);
# 1625 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1694 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_panic (flux_t *h, uint32_t nodeid, int flags, const char *reason);
# 1723 "/__w/flux-python/flux-python/src/_core_clean.h"
enum event_flags {
...
# 1834 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1907 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1955 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1993 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2120 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_register (flux_t *h, const char *name);
# 2132 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_unregister (flux_t *h, const char *name);
# 2184 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2222 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 2309 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_plugin_arg_vunpack (flux_plugin_arg_t *args, int flags,
                             const char *fmt, va_list ap);
# 2378 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_call (flux_plugin_t *p, const char *name,
                      flux_plugin_arg_t *args);
# 2388 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_load_dso (flux_plugin_t *p, const char *path);
# 2421 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_sync_create (flux_t *h, double minimum);
# 2453 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2522 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2605 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct flux_kvsdir flux_kvsdir_t;
typedef struct flux_kvsitr flux_kvsitr_t;
# 2620 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2693 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2743 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_getroot (flux_t *h, const char *ns, int flags);
# 2752 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2784 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_kvs_txn_symlink (flux_kvs_txn_t *txn, int flags,
                          ...
                          const char *target);
# 2862 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2918 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_copy (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2935 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_move (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2958 "/__w/flux-python/flux-python/src/_core_clean.h"
enum kvs_op {
    FLUX_KVS_READDIR = 1,
    FLUX_KVS_READLINK = 2,
    FLUX_KVS_WATCH = 4,
...
# 3027 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3108 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_job_result_get (flux_future_t *f,
                         const char **json_str);
# 3239 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_result_get_unpack (flux_future_t *f, const char *fmt, ...);
# 3253 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_timeleft (flux_t *h, flux_error_t *errp, double *timeleft);
# 3269 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_jobspec1_t *flux_jobspec1_decode (const char *s,
                                       flux_jobspec1_error_t *error);
# 3408 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3450 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3470 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef enum {
...
typedef void (*subprocess_log_f) (void *arg,
                                  ...
                                  const char *fmt,
                                  va_list args);
# 3554 "/__w/flux-python/flux-python/src/_core_clean.h"
void flux_standard_output (flux_subprocess_t *p, const char *stream);
# 3563 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_subprocess_t *flux_rexec_ex (flux_t *h,
                                  ...
                                  subprocess_log_f log_fn,
                                  void *log_data);
# 3758 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3789 "/__w/flux-python/flux-python/src/_core_clean.h"
const char *flux_subprocess_read (flux_subprocess_t *p,
                                  const char *stream,
                                  int len, int *lenp);
# 3804 "/__w/flux-python/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read_trimmed_line (flux_subprocess_t *p,
                                               const char *stream,
                                               int *lenp);
# 3824 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_subprocess_read_stream_closed (flux_subprocess_t *p,
                                        const char *stream);
# 3843 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3944 "/__w/flux-python/flux-python/src/_core_clean.h"
