...
# 3026 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3100 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_job_result_get (flux_future_t *f,
                         const char **json_str);
# 3242 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_result_get_unpack (flux_future_t *f, const char *fmt, ...);
# 3256 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_timeleft (flux_t *h, flux_error_t *errp, double *timeleft);
# 3272 "/__w/flux-python/flux-python/src/_core_clean.h"
char *flux_unwrap_string (const char *in,
                          bool verify,
                          uint32_t *userid,
                          flux_error_t *error);
# 3300 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_jobspec1_t *flux_jobspec1_decode (const char *s,
                                       flux_jobspec1_error_t *error);
# 3411 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3453 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3473 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef enum {
...
typedef void (*subprocess_log_f) (void *arg,
                                  ...
                                  const char *fmt,
                                  va_list args);
# 3557 "/__w/flux-python/flux-python/src/_core_clean.h"
void flux_standard_output (flux_subprocess_t *p, const char *stream);
# 3566 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3653 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3726 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_subprocess_t *flux_rexec_ex (flux_t *h,
                                  ...
                                  subprocess_log_f log_fn,
                                  void *log_data);
# 3761 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3792 "/__w/flux-python/flux-python/src/_core_clean.h"
const char *flux_subprocess_read (flux_subprocess_t *p,
                                  const char *stream,
                                  int len, int *lenp);
# 3807 "/__w/flux-python/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read_trimmed_line (flux_subprocess_t *p,
                                               const char *stream,
                                               int *lenp);
# 3827 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3873 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3947 "/__w/flux-python/flux-python/src/_core_clean.h"
