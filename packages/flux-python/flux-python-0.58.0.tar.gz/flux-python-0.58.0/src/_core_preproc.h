...
# 665 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 691 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 706 "/__w/flux-python/flux-python/src/_core_clean.h"
const void *flux_buffer_peek (flux_buffer_t *fb, int len, int *lenp);
# 716 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 792 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 904 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 989 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1028 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1168 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1189 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_msglist_pollevents (struct flux_msglist *l);
int flux_msglist_pollfd (struct flux_msglist *l);
# 1225 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_msg_t *flux_request_encode_raw (const char *topic,
                                     const void *data, int len);
# 1291 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_response_decode (const flux_msg_t *msg,
                          const char **topic,
                          const char **s);
# 1303 "/__w/flux-python/flux-python/src/_core_clean.h"
...
void flux_llog (void *arg,
                ...
                const char *fmt,
                va_list ap);
# 1526 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1604 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_future_fulfill_next (flux_future_t *prev,
                              void *result,
                              flux_free_f free_fn);
# 1646 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1835 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1960 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1998 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_conf_unpack (const flux_conf_t *conf,
                      flux_error_t *error,
                      const char *fmt, ...);
# 2082 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_barrier (flux_t *h, const char *name, int nprocs);
# 2125 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_register (flux_t *h, const char *name);
# 2137 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_unregister (flux_t *h, const char *name);
# 2189 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2227 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 2314 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_plugin_arg_vunpack (flux_plugin_arg_t *args, int flags,
                             const char *fmt, va_list ap);
# 2383 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_call (flux_plugin_t *p, const char *name,
                      flux_plugin_arg_t *args);
# 2393 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2458 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_msglist_cancel (flux_t *h,
                         ...
                         const flux_msg_t *msg);
# 2527 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2610 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct flux_kvsdir flux_kvsdir_t;
typedef struct flux_kvsitr flux_kvsitr_t;
# 2625 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2700 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2754 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_getroot (flux_t *h, const char *ns, int flags);
# 2763 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2795 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2894 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_future_t *flux_kvs_move (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2995 "/__w/flux-python/flux-python/src/_core_clean.h"
enum kvs_op {
    FLUX_KVS_READDIR = 1,
    FLUX_KVS_READLINK = 2,
    FLUX_KVS_WATCH = 4,
...
# 3016 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3067 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3152 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_job_result_get (flux_future_t *f,
                         const char **json_str);
# 3283 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3313 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_jobspec1_t *flux_jobspec1_decode (const char *s,
                                       flux_jobspec1_error_t *error);
# 3452 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3494 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3514 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef enum {
...
typedef void (*subprocess_log_f) (void *arg,
                                  ...
                                  const char *fmt,
                                  va_list args);
# 3598 "/__w/flux-python/flux-python/src/_core_clean.h"
void flux_standard_output (flux_subprocess_t *p, const char *stream);
# 3607 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3694 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3770 "/__w/flux-python/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read (flux_subprocess_t *p,
                                  const char *stream,
                                  int len, int *lenp);
# 3854 "/__w/flux-python/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read_trimmed_line (flux_subprocess_t *p,
                                               const char *stream,
                                               int *lenp);
# 3874 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_subprocess_read_stream_closed (flux_subprocess_t *p,
                                        const char *stream);
# 3893 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3920 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3994 "/__w/flux-python/flux-python/src/_core_clean.h"
