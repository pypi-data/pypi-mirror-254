...
# 1690 "/__w/flux-python/flux-python/src/_core_clean.h"
enum event_flags {
...
# 1801 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1874 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1926 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1964 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_conf_unpack (const flux_conf_t *conf,
                      flux_error_t *error,
                      const char *fmt, ...);
# 2048 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2103 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_unregister (flux_t *h, const char *name);
# 2155 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2193 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 2280 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_plugin_arg_vunpack (flux_plugin_arg_t *args, int flags,
                             const char *fmt, va_list ap);
# 2349 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_call (flux_plugin_t *p, const char *name,
                      flux_plugin_arg_t *args);
# 2359 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2493 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2576 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct flux_kvsdir flux_kvsdir_t;
typedef struct flux_kvsitr flux_kvsitr_t;
# 2591 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2664 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2714 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_getroot (flux_t *h, const char *ns, int flags);
# 2723 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2755 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_kvs_txn_symlink (flux_kvs_txn_t *txn, int flags,
                          ...
                          const char *target);
# 2833 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2889 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_copy (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2906 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_move (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2929 "/__w/flux-python/flux-python/src/_core_clean.h"
enum kvs_op {
    FLUX_KVS_READDIR = 1,
    FLUX_KVS_READLINK = 2,
    FLUX_KVS_WATCH = 4,
...
# 2950 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3071 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_id_encode (flux_jobid_t id, const char *type,
                        char *buf, size_t bufsz);
# 3082 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_job_result_get (flux_future_t *f,
                         const char **json_str);
# 3213 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_result_get_unpack (flux_future_t *f, const char *fmt, ...);
# 3227 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_timeleft (flux_t *h, flux_error_t *errp, double *timeleft);
# 3243 "/__w/flux-python/flux-python/src/_core_clean.h"
char *flux_unwrap_string (const char *in,
                          bool verify,
                          uint32_t *userid,
                          flux_error_t *error);
# 3271 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_jobspec1_t *flux_jobspec1_decode (const char *s,
                                       flux_jobspec1_error_t *error);
# 3382 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3424 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3444 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef enum {
...
typedef void (*subprocess_log_f) (void *arg,
                                  ...
                                  const char *fmt,
                                  va_list args);
# 3528 "/__w/flux-python/flux-python/src/_core_clean.h"
void flux_standard_output (flux_subprocess_t *p, const char *stream);
# 3537 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3624 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_cmd_add_channel (flux_cmd_t *cmd, const char *name);
# 3674 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_subprocess_t *flux_rexec_ex (flux_t *h,
                                  ...
                                  subprocess_log_f log_fn,
                                  void *log_data);
# 3732 "/__w/flux-python/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read (flux_subprocess_t *p,
                                  const char *stream,
                                  int len, int *lenp);
# 3778 "/__w/flux-python/flux-python/src/_core_clean.h"
...
const char *flux_subprocess_read_trimmed_line (flux_subprocess_t *p,
                                               const char *stream,
                                               int *lenp);
# 3798 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_subprocess_read_stream_closed (flux_subprocess_t *p,
                                        const char *stream);
# 3817 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3844 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3918 "/__w/flux-python/flux-python/src/_core_clean.h"
