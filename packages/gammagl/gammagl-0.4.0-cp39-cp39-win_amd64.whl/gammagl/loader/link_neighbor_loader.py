...
class LinkNeighborLoader(LinkLoader):
    ...
    edge_label_index: tensor or str or tuple[str, tensor]
    ...
    edge_label_time: tensor, optional
        The timestamps for edge indices
    ...
    time_attr: str, optional
        The name of the attribute that denotes
    ...
    is_sorted: bool, optional
        If set to :obj:`True`, assumes that
