...
class RandomLinkSplit(BaseTransform):
    ...
    is_undirected: bool, optional
        ...
        (default: :obj:`False`)
    key: str, optional
        The name of the attribute holding
        ground-truth labels.
    ...
    neg_sampling_ratio: float, optional
        The ratio of sampled negative
        edges to the number of positive edges. (default: :obj:`1.0`)
    disjoint_train_ratio: int, float, optional
        If set to a value
