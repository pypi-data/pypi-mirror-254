...
class SDP():
    ...
    async def get_data(self, api_method: str(), input_data: dict()=None):
        ...
        async with aiohttp.ClientSession(headers=self.headers) as session:
            async with session.get(self.api_url_base+'/'+api_method, params=params, ssl=self.ssl_verify_disable) as resp:
    ...
    async def post_data(self, api_method: str(), input_data: dict()=None):
        ...
        if input_data:
            ...
            params = None
        async with aiohttp.ClientSession(headers=self.headers) as session:
            async with session.post(self.api_url_base+'/'+api_method, params=params, ssl=self.ssl_verify_disable) as resp:
                return await resp.json()
    ...
    async def put_data(self, api_method: str(), input_data: dict()=None):
        ...
        if input_data:
            ...
            params = None
        async with aiohttp.ClientSession(headers=self.headers) as session:
            async with session.put(self.api_url_base+'/'+api_method, params=params, ssl=self.ssl_verify_disable) as resp:
                return await resp.json()
    ...
    async def delete_data(self, api_method: str(), input_data: dict()=None):
        ...
        if input_data:
            ...
            params = None
        async with aiohttp.ClientSession(headers=self.headers) as session:
            async with session.delete(self.api_url_base+'/'+api_method, params=params, ssl=self.ssl_verify_disable) as resp:
                return await resp.json()
    ...
    async def send_file(self, file_path, method, http_method='post'):
        ...
        async with aiohttp.ClientSession(headers=headers) as session:
            if http_method == 'post':
                async with session.post(self.api_url_base+'/'+method, data=data, ssl=self.ssl_verify_disable) as resp:
                    return await resp.json()
            elif http_method == 'put':
                async with session.put(self.api_url_base+'/'+method, data=data, ssl=self.ssl_verify_disable) as resp:
                    return await resp.json()
            else:
