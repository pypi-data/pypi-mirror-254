...
from typing import (Self, Union, Optional, ClassVar)

# %% ../nbs/04_iatt.ipynb 9
from pdec import slotprops, Property

# %% ../nbs/04_iatt.ipynb 11
from itry.cons import (
    ATTR, ASSET, AREPR, BASES, IMPORTED, NAMESPACE, DEFAULT,
    _AREPR, _ASSET, _IMPORTED
)
from .atyp import T, Types, Namespace, ImportedAsset
from .util import Spec
from .imod import imod

# %% ../nbs/04_iatt.ipynb 13
@slotprops(dict(
