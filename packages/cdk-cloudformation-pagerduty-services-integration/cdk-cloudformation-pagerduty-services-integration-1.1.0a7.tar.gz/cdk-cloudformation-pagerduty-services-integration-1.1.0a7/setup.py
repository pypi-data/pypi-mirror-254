...
kwargs = json.loads(
    """
{
    "name": "cdk-cloudformation-pagerduty-services-integration",
    "version": "1.1.0.a7",
    ...
    "packages": [
        "cdk_cloudformation_pagerduty_services_integration",
        "cdk_cloudformation_pagerduty_services_integration._jsii"
    ],
    "package_data": {
        "cdk_cloudformation_pagerduty_services_integration._jsii": [
            "pagerduty-services-integration@1.1.0-alpha.7.jsii.tgz"
        ],
        "cdk_cloudformation_pagerduty_services_integration": [
            "py.typed"
        ]
