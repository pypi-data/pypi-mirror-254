...
# %% auto 0
__all__ = ['T', 'O', 'GuardLike', 'iscall', 'isnone', 'notnone', 'isstr', 'allstrs', 'istuple', 'insattr', 'astrmeta', 'astr',
           'attr']
...
from nlit import (
    GET, ATTR, BASES, RETHAS, NAMESPACE, 
...
class astrmeta(type):
    ...
    clsvars: tuple[str, ...] = ('attr', 'check', 'guard', 'checkobj', 'guardobj', 'retself', 'default')
...
@wraps(astr, assigned=('__module__', '__doc__', '__annotations__'), updated=())
class attr(astr):
    '''An alias for the `attr` class.
    
    See Also
    --------
    attr : A class for getting, setting and checking if an object has an attribute.
    '''
