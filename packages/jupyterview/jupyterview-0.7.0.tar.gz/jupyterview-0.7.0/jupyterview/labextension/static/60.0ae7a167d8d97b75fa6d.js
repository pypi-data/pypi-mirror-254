(self["webpackChunkjupyterview"] = self["webpackChunkjupyterview"] || []).push([[60],{
...
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/application@^4.0.12 (singleton)
var application_4_0_singleton_ = __webpack_require__(3320);
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/apputils@^4.1.12 (singleton)
var apputils_4_1_singleton_ = __webpack_require__(7176);
// EXTERNAL MODULE: consume shared module (default) @lumino/algorithm@^2.0.0 (singleton)
var algorithm_2_0_singleton_ = __webpack_require__(6620);
// EXTERNAL MODULE: consume shared module (default) @lumino/coreutils@^2.0.0 (singleton)
var coreutils_2_0_singleton_ = __webpack_require__(2464);
...
// EXTERNAL MODULE: consume shared module (default) @jupyterlab/docregistry@^4.0.12
var docregistry_4_0 = __webpack_require__(2048);
// EXTERNAL MODULE: consume shared module (default) @lumino/signaling@^2.0.0 (singleton)
var signaling_2_0_singleton_ = __webpack_require__(2292);
// EXTERNAL MODULE: consume shared module (default) @jupyter/ydoc@^1.1.1 (singleton)
var ydoc_1_1_singleton_ = __webpack_require__(1312);
...
class JupyterViewDoc extends ydoc_1_1_singleton_.YDocument {
    constructor() {
        super();
        /**
         * Document version
...
class MainView extends consume_shared_module_default_react_18_2_singleton_.Component {
    constructor(props) {
        ...
        this.updateColorBy = (color) => {
            ...
            let colorMode = Constants/* ColorMode */.qy.DEFAULT;
            let scalarMode = Constants/* ScalarMode */.oh.DEFAULT;
            ...
            if (scalarVisibility) {
                ...
                colorMode = Constants/* ColorMode */.qy.MAP_SCALARS;
                scalarMode =
                    location === 'PointData'
                        ? Constants/* ScalarMode */.oh.USE_POINT_FIELD_DATA
                        : Constants/* ScalarMode */.oh.USE_CELL_FIELD_DATA;
        ...
        this.applyPreset = (options) => {
            ...
            const preset = ColorMaps/* default */.c.getPresetByName(options.colorSchema);
        ...
        this.createPipeline = (polyResult) => {
            this._lookupTable = ColorTransferFunction/* default.newInstance */.cp.newInstance();
            this._mapper = Mapper/* default.newInstance */.cp.newInstance({
                interpolateScalarsBeforeMapping: true,
                useLookupTableScalarRange: true,
                scalarVisibility: false
            });
            this._mapper.setLookupTable(this._lookupTable);
            this._actor = Actor/* default.newInstance */.cp.newInstance();
            ...
            this._warpScalar = WarpScalar/* default.newInstance */.cp.newInstance({
                scaleFactor: 0,
                useNormal: true
            });
            ...
            this._scalarBarActor = ScalarBarActor/* default.newInstance */.cp.newInstance();
    ...
    componentDidMount() {
        setTimeout(() => {
            ...
            this._fullScreenRenderer = RenderWindowWithControlBar/* default.newInstance */.cp.newInstance({
                controlSize: 0
            });
            ...
            const axes = AxesActor/* default.newInstance */.cp.newInstance();
            const orientationWidget = OrientationMarkerWidget/* default.newInstance */.cp.newInstance({
                actor: axes,
            ...
            const widgetManager = WidgetManager/* default.newInstance */.cp.newInstance();
            widgetManager.setRenderer(orientationWidget.getRenderer());
            const widget = InteractiveOrientationWidget/* default.newInstance */.cp.newInstance();
            ...
            vw.onOrientationChange(({ up, direction, action, event }) => {
                ...
                const position = camera.getPosition();
                const viewUp = camera.getViewUp();
                const distance = Math.sqrt(Core_Math/* distance2BetweenPoints */.MD(position, focalPoint));
                ...
                for (const [path, promise] of entries) {
                    ...
                    promise.then(vtkParsedContent => {
                        this.stringToPolyData(vtkParsedContent.binary, `${name}.${vtkParsedContent.type}`)
                            ...
                            this._fileData[path] = (0,vtk/* default */.c)(polyResult.polyData);
    ...
    async stringToPolyData(fileContent, filePath) {
        ...
        return fetch(str)
            ...
            .then(buff => (0,readPolyDataArrayBuffer/* default */.c)(null, buff, filePath, ''))
            .then(polyResult => {
            polyResult.webWorker.terminate();
            return polyResult;
        });
...
class JupyterViewPanel extends apputils_4_1_singleton_.ReactWidget {
    /**
...
// EXTERNAL MODULE: ./node_modules/@mui/material/Accordion/Accordion.js + 18 modules
var Accordion = __webpack_require__(88);
// EXTERNAL MODULE: ./node_modules/@mui/material/AccordionDetails/AccordionDetails.js + 1 modules
var AccordionDetails = __webpack_require__(8748);
// EXTERNAL MODULE: ./node_modules/@mui/material/AccordionSummary/AccordionSummary.js + 9 modules
var AccordionSummary = __webpack_require__(8846);
...
class ColorPanel extends consume_shared_module_default_react_18_2_singleton_.Component {
    constructor(props) {
        ...
        this._colorMapOptions = ColorMaps/* default */.c.rgbPresetNames.map(option => ({ value: option, label: option }));
    }
    render() {
        var _a;
...
class panelview_MainView extends consume_shared_module_default_react_18_2_singleton_.Component {
    ...
    render() {
        return (consume_shared_module_default_react_18_2_singleton_.createElement("div", { className: "jpview-control-panel" },
            ...
            consume_shared_module_default_react_18_2_singleton_.createElement(Accordion/* default */.c, { expanded: this.state.datasetPanel, sx: { margin: '0px 0px' } },
                consume_shared_module_default_react_18_2_singleton_.createElement(AccordionSummary/* default */.c, { expandIcon: consume_shared_module_default_react_18_2_singleton_.createElement(ExpandMore/* default */.c, null), "aria-controls": "dataSetPanela-content", id: "displayPanela-header", sx: panelTitleStyle, onClick: () => this.togglePanel('datasetPanel') },
                    consume_shared_module_default_react_18_2_singleton_.createElement("span", null, "Dataset")),
                consume_shared_module_default_react_18_2_singleton_.createElement(AccordionDetails/* default */.c, { sx: panelBodyStyle },
            ...
            consume_shared_module_default_react_18_2_singleton_.createElement(Accordion/* default */.c, { expanded: this.state.displayPanel },
                consume_shared_module_default_react_18_2_singleton_.createElement(AccordionSummary/* default */.c, { expandIcon: consume_shared_module_default_react_18_2_singleton_.createElement(ExpandMore/* default */.c, null), "aria-controls": "displayPanela-content", id: "displayPanela-header", sx: panelTitleStyle, onClick: () => this.togglePanel('displayPanel') },
            ...
            consume_shared_module_default_react_18_2_singleton_.createElement(Accordion/* default */.c, { expanded: this.state.colorPanel },
                consume_shared_module_default_react_18_2_singleton_.createElement(AccordionSummary/* default */.c, { expandIcon: consume_shared_module_default_react_18_2_singleton_.createElement(ExpandMore/* default */.c, null), "aria-controls": "colorPanela-content", id: "colorPanela-header", sx: panelTitleStyle, onClick: () => this.togglePanel('colorPanel') },
                    consume_shared_module_default_react_18_2_singleton_.createElement("span", { className: "lm-Widget" }, "Color")),
                consume_shared_module_default_react_18_2_singleton_.createElement(AccordionDetails/* default */.c, { sx: panelBodyStyle, className: 'lm-Widget' },
            ...
            consume_shared_module_default_react_18_2_singleton_.createElement(Accordion/* default */.c, { expanded: this.state.filterPanel },
                consume_shared_module_default_react_18_2_singleton_.createElement(AccordionSummary/* default */.c, { expandIcon: consume_shared_module_default_react_18_2_singleton_.createElement(ExpandMore/* default */.c, null), "aria-controls": "filterPanela-content", id: "filterPanela-header", sx: panelTitleStyle, onClick: () => this.togglePanel('filterPanel') },
...
class PanelWidget extends apputils_4_1_singleton_.ReactWidget {
    constructor(tracker) {
        var _a, _b;
        super();
...
class VtkTracker extends apputils_4_1_singleton_.WidgetTracker {
    constructor() {
        super(...arguments);
...
const lib_plugin = {
    ...
    autoStart: true,
    requires: [application_4_0_singleton_.ILayoutRestorer, apputils_4_1_singleton_.IThemeManager, application_4_0_singleton_.ILabShell],
...
/* harmony export */ });
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8281);
