...
class _OrderExecutionOptionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_OrderExecutionOption.ValueType], builtins.type):
    ...
    ORDER_EXECUTION_OPTION_NONE: _OrderExecutionOption.ValueType  # 1
...
"""UNSPECIFIED: The order execution option has not been set."""
ORDER_EXECUTION_OPTION_NONE: OrderExecutionOption.ValueType  # 1
"""Order remains open until it's fully fulfilled, cancelled by the client,
`valid_until` timestamp is reached, or the end of the trading session.
"""
...
class _OrderStateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_OrderState.ValueType], builtins.type):
    ...
    being met.
    """
    ORDER_STATE_RECALL: _OrderState.ValueType  # 10
...
being met.
"""
ORDER_STATE_RECALL: OrderState.ValueType  # 10
"""RECALL: The order has been recalled. This could be due to a system issue or
a request from the market participant or market operator.
"""
ORDER_STATE_RECALL_REQUESTED: OrderState.ValueType  # 11
"""RECALL_REQUESTED: A recall request for the order has been submitted but the
order is not yet removed from the order book.
"""
ORDER_STATE_RECALL_REJECTED: OrderState.ValueType  # 12
"""RECALL_REJECTED: The order recall request was rejected, likely due to it
having already been filled or expired.
"""
ORDER_STATE_APPROVAL: OrderState.ValueType  # 13
"""APPROVAL: The order has been sent for approval."""
...
class Order(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_execution_option", b"_execution_option", "_tag", b"_tag", "delivery_area", b"delivery_area", "delivery_period", b"delivery_period", "display_quantity", b"display_quantity", "execution_option", b"execution_option", "payload", b"payload", "peak_price_delta", b"peak_price_delta", "price", b"price", "quantity", b"quantity", "stop_price", b"stop_price", "tag", b"tag", "valid_until", b"valid_until"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_execution_option", b"_execution_option", "_tag", b"_tag", "delivery_area", b"delivery_area", "delivery_period", b"delivery_period", "display_quantity", b"display_quantity", "execution_option", b"execution_option", "payload", b"payload", "peak_price_delta", b"peak_price_delta", "price", b"price", "quantity", b"quantity", "side", b"side", "stop_price", b"stop_price", "tag", b"tag", "type", b"type", "valid_until", b"valid_until"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_execution_option", b"_execution_option"]) -> typing_extensions.Literal["execution_option"] | None: ...
    @typing.overload
...
class OrderDetail(google.protobuf.message.Message):
    ...
    class StateDetail(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["market_actor", b"market_actor", "state", b"state", "state_reason", b"state_reason"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "filled_quantity", b"filled_quantity", "modification_time", b"modification_time", "open_quantity", b"open_quantity", "order", b"order", "state_detail", b"state_detail"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "filled_quantity", b"filled_quantity", "modification_time", b"modification_time", "open_quantity", b"open_quantity", "order", b"order", "order_id", b"order_id", "state_detail", b"state_detail"]) -> None: ...
...
class PublicTrade(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["buy_delivery_area", b"buy_delivery_area", "delivery_period", b"delivery_period", "modification_time", b"modification_time", "price", b"price", "quantity", b"quantity", "sell_delivery_area", b"sell_delivery_area"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["buy_delivery_area", b"buy_delivery_area", "delivery_period", b"delivery_period", "id", b"id", "modification_time", b"modification_time", "price", b"price", "quantity", b"quantity", "sell_delivery_area", b"sell_delivery_area", "state", b"state"]) -> None: ...
...
class GridpoolOrderFilter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_side", b"_side", "_tag", b"_tag", "delivery_area", b"delivery_area", "delivery_period", b"delivery_period", "side", b"side", "tag", b"tag"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_side", b"_side", "_tag", b"_tag", "delivery_area", b"delivery_area", "delivery_period", b"delivery_period", "side", b"side", "states", b"states", "tag", b"tag"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_side", b"_side"]) -> typing_extensions.Literal["side"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_tag", b"_tag"]) -> typing_extensions.Literal["tag"] | None: ...
...
class PublicTradeFilter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["buy_delivery_area", b"buy_delivery_area", "delivery_period", b"delivery_period", "sell_delivery_area", b"sell_delivery_area"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["buy_delivery_area", b"buy_delivery_area", "delivery_period", b"delivery_period", "sell_delivery_area", b"sell_delivery_area", "states", b"states"]) -> None: ...
...
class CreateGridpoolOrderRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["gridpool_id", b"gridpool_id", "order", b"order"]) -> None: ...
...
class CreateGridpoolOrderResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["order_detail", b"order_detail"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["gridpool_id", b"gridpool_id", "order_detail", b"order_detail"]) -> None: ...
...
class UpdateGridpoolOrderRequest(google.protobuf.message.Message):
    ...
    class UpdateOrder(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_tag", b"_tag", "display_quantity", b"display_quantity", "payload", b"payload", "peak_price_delta", b"peak_price_delta", "price", b"price", "quantity", b"quantity", "stop_price", b"stop_price", "tag", b"tag", "valid_until", b"valid_until"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_tag", b"_tag", "display_quantity", b"display_quantity", "execution_option", b"execution_option", "payload", b"payload", "peak_price_delta", b"peak_price_delta", "price", b"price", "quantity", b"quantity", "stop_price", b"stop_price", "tag", b"tag", "valid_until", b"valid_until"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_tag", b"_tag"]) -> typing_extensions.Literal["tag"] | None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["update_mask", b"update_mask", "update_order_fields", b"update_order_fields"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["gridpool_id", b"gridpool_id", "order_id", b"order_id", "update_mask", b"update_mask", "update_order_fields", b"update_order_fields"]) -> None: ...
...
class CancelGridpoolOrderRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["gridpool_id", b"gridpool_id", "order_id", b"order_id"]) -> None: ...
...
class CancelAllGridpoolOrdersRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["gridpool_id", b"gridpool_id"]) -> None: ...
...
class ListGridpoolOrdersRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["filter", b"filter", "gridpool_id", b"gridpool_id", "pagination_params", b"pagination_params"]) -> None: ...
...
class ListGridpoolOrdersResponse(google.protobuf.message.Message):
    ...
    ORDER_DETAIL_LISTS_FIELD_NUMBER: builtins.int
    PAGINATION_INFO_FIELD_NUMBER: builtins.int
    @property
    def order_detail_lists(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___OrderDetail]:
    ...
    def __init__(
        self,
        *,
        order_detail_lists: collections.abc.Iterable[global___OrderDetail] | None = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["order_detail_lists", b"order_detail_lists", "pagination_info", b"pagination_info"]) -> None: ...
...
class ReceiveGridpoolOrdersStreamRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["filter", b"filter", "gridpool_id", b"gridpool_id"]) -> None: ...
...
class ReceiveGridpoolOrdersStreamResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["order_detail", b"order_detail"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["order_detail", b"order_detail"]) -> None: ...
...
class ListPublicTradesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["filter", b"filter", "pagination_params", b"pagination_params"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["filter", b"filter", "pagination_params", b"pagination_params"]) -> None: ...
...
class ListPublicTradesResponse(google.protobuf.message.Message):
    ...
    PUBLIC_TRADE_LISTS_FIELD_NUMBER: builtins.int
    PAGINATION_INFO_FIELD_NUMBER: builtins.int
    @property
    def public_trade_lists(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PublicTrade]:
    ...
    def __init__(
        self,
        *,
        public_trade_lists: collections.abc.Iterable[global___PublicTrade] | None = ...,
        pagination_info: frequenz.api.common.v1.pagination.pagination_info_pb2.PaginationInfo | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["pagination_info", b"pagination_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pagination_info", b"pagination_info", "public_trade_lists", b"public_trade_lists"]) -> None: ...
...
class ReceivePublicTradesStreamResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["public_trade", b"public_trade"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["public_trade", b"public_trade"]) -> None: ...
