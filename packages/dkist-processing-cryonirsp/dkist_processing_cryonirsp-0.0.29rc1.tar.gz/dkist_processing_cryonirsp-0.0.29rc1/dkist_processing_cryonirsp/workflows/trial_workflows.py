...
full_trial_ci_pipeline.add_node(task=CreateTrialDatasetInventory, upstreams=CIWriteL1Frame)
full_trial_ci_pipeline.add_node(task=CreateTrialAsdf, upstreams=CIWriteL1Frame)
full_trial_ci_pipeline.add_node(
...
full_trial_sp_pipeline.add_node(task=CreateTrialDatasetInventory, upstreams=SPWriteL1Frame)
full_trial_sp_pipeline.add_node(task=CreateTrialAsdf, upstreams=SPWriteL1Frame)
full_trial_sp_pipeline.add_node(
    task=TransferCryoTrialData,
