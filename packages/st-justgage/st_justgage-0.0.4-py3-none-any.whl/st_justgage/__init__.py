...
def st_justgage(value: int, min_value: int, max_value: int,second_value:int=None, title: str=None, title_fontsize=20,title_color=None, key: str = None, customCSS: str = "",
    ...
    pointerOptions = {},second_pointerOptions = {},displayRemaining = False):
    """
    Creates a JustGage display, a customizable gauge instrument, using Streamlit components.
    ...
    textRenderer : callable, optional
        A function to customize the text for the gauge value.
    ...
    minLabelMinFontSize : int, optional
        The minimum font size of the minimum value.
    maxLabelMinFontSize : int, optional
        The minimum font size of the maximum value.
    hideValue : bool, optional
        Whether to hide the value.
    hideMinMax : bool, optional
        Whether to hide the min and max values.
    showInnerShadow : bool, optional
        Whether to display an inner shadow.
    humanFriendly : bool, optional
        Whether to format numbers in a human-friendly way.
    noGradient : bool, optional
        Whether to disable the color gradient.
    donut : bool, optional
        Whether to display the gauge as a donut.
    differential : bool, optional
        Whether to display only the difference from the previous value.
    ...
    customSectors : dict, optional
        A dictionary defining custom sectors and their colors.
    formatNumber : bool, optional
        Whether to format numbers (e.g., with thousands separator).
    pointerOptions : dict, optional
        Options for customizing the pointer.
    second_pointerOptions : dict, optional
        Options for customizing the second pointer, if enabled.
    ...
    -------
    component_value
        The value of the component, typically used for internal purposes.
    """
    ...
    component_value = _component_func(value=value,second_value=second_value,second_pointer=second_pointer, min_value=min_value, max_value=max_value,title=title,title_fontsize=title_fontsize,title_color=title_color, key=key, customCSS=customCSS,
        ...
        pointer = pointer,pointerOptions = pointerOptions,second_pointerOptions=second_pointerOptions,displayRemaining = displayRemaining
    )
