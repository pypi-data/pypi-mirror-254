...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, content_guard=None, base_path=None, hidden=False, pulp_labels=None, name=None, repository=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
