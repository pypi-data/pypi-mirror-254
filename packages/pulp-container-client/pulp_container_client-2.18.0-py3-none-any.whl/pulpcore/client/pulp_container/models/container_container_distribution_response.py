...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, base_path=None, pulp_href=None, hidden=False, pulp_labels=None, name=None, repository=None, pulp_created=None, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
