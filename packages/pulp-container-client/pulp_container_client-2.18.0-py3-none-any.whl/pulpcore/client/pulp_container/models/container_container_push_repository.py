...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, manifest_signing_service=None, name=None, retain_repo_versions=None, description=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
