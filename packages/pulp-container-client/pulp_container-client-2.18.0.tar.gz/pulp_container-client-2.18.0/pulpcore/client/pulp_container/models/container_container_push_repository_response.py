...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, manifest_signing_service=None, latest_version_href=None, name=None, retain_repo_versions=None, pulp_href=None, description=None, pulp_labels=None, versions_href=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
