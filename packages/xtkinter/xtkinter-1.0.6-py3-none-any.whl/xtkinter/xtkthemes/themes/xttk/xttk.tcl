...
namespace eval ttk::theme::xttk {
    ...
    LoadImages [file join [file dirname [info script]] xttk]

    ttk::style theme create xttk -parent default -settings {
        ttk::style configure . \
...
package provide ttk::theme::xttk $version
