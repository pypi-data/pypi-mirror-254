...
DEEPL_LANGUAGES = json.load(open("./data/deepl_languages.json","r"))
GOOGLE_LANGUAGES = json.load(open("./data/google_languages.json","r"))
GENERAL_LANGUAGES = json.load(open("./data/general_languages.json","r"))
