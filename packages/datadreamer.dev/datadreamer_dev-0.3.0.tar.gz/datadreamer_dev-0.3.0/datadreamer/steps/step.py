...
from .data_card import sort_data_card
...
class Step(metaclass=StepMeta):
    ...
    def _data_card(self) -> dict:
        for step_name in self.__registered["data_card"]:
            sort_data_card(self.__registered["data_card"][step_name])
        return json.loads(json.dumps(self.__registered["data_card"]))
