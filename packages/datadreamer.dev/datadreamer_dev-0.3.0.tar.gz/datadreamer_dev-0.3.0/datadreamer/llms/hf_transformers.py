...
class HFTransformers(LLM):
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            model_name: Test.
            chat_prompt_template: _description_. Defaults to AUTO.
            system_prompt: _description_. Defaults to AUTO.
            revision: _description_. Defaults to None.
            ...
            cache_folder_path: _description_. Defaults to None.
