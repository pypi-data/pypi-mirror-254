...
class CodeObject(CodeObjectCreateInput):
    """
    @autoapi True
    ...
    created_at: str
    """@autoapi True When this CodeObject was added"""
    _project: Any = None
    ...
    def creator(self):
        ...
        Get the User who created the CodeObject

        .. warning:: The result of this function is cached.
            Be careful calling this function after making changes to the CodeObject

        Returns
        -------
        user: User
            The User who created the CodeObject
    ...
    def project(self):
        ...
        Get the project of this CodeObject
    ...
    def input_data_schemas(self):
        """
        Returns the input data schemas for this CodeObject
    ...
    def output_data_schemas(self):
        """
        Returns the output data schemas for this CodeObject
