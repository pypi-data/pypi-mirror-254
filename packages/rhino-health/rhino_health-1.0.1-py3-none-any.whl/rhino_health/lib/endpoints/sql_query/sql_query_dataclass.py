...
class SQLQuery(SQLQueryBase):
    ...
    def creator(self):
        ...
        Get the User who created the SQLQuery
        ...
        .. warning:: The result of this function is cached.
            Be careful calling this function after making changes to the SQLQuery.

        Returns
        -------
        user: User
            The User who created the SQLQuery
