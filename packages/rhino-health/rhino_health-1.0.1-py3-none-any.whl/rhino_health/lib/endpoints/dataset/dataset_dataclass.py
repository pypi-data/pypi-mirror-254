...
class BaseDataset(RhinoBaseModel):
    ...
    def project(self):
        ...
        Get the project of this Dataset
...
class LTSDataset(BaseDataset):
    ...
    created_at: str
    """
    @autoapi True When this Dataset was added
    """
    num_cases: int
    """
...
class Dataset(LTSDataset):
    ...
    def creator(self):
        ...
        .. warning:: The result of this function is cached.
            Be careful calling this function after making changes to the Dataset.
    ...
    def primary_workgroup(self):
        """
        Return the primary workgroup associated with this Dataset
        ...
        primary_workgroup: Workgroup
            DataClasses representing the Primary Workgroup of the Dataset
        """
    ...
    def data_schema(self):
        """
        Return the data_schema associated with this Dataset
        ...
        data_schema: DataSchema
            DataClasses representing the DataSchema of the Dataset
        """
