...
BASE_EXCEPTION_GROUP_ERROR_DESCRIPTION: str = "Multiple simultaneous exceptions were grouped together."
...
BASE_EXCEPTION_GROUP_DICT: dict = {
	GENERIC_ERROR_KEY: ExceptionGroup.__name__,
	GENERIC_MESSAGE_KEY: "",
	GENERIC_DESCRIPTION_KEY: BASE_EXCEPTION_GROUP_ERROR_DESCRIPTION,
}
