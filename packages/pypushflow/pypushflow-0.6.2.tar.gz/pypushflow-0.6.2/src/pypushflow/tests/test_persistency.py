...
def pymongo_client():
    client = init_db_client(db_type="pymongo")
    client.connect(
...
def besdb_client():
    os.environ.setdefault(
        "PYPUSHFLOW_MONGOURL", "mongodb://user:pwd@localhost:27017/bes"
    )
    os.environ.setdefault("PYPUSHFLOW_INITIATOR", "PyPushflowUnitTests")
