...
class PaperBroker(BaseBroker, ABC, metaclass=abc.ABCMeta):
    ...
    async def place_order(self, *, broker_symbol: BrokerSymbol, quantities: int, market_type: MarketType, product_type: ProductType, order_type: OrderType, position_type: PositionType, position_id: str | None) -> None: ...
