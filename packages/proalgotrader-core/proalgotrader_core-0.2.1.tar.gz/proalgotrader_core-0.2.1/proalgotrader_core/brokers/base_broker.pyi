...
class BaseBroker(metaclass=abc.ABCMeta):
    ...
    async def get_order_info(self, data: Dict[str, Any]): ...
    async def get_position_info(self, data: Dict[str, Any]): ...
    ...
    def get_symbol(self, broker_symbol: Dict[str, Any]) -> BrokerSymbol: ...
    def get_positions(self, symbol_name: str, order_type: str, product_type: str, position_type: str) -> List[Position]: ...
    ...
    async def set_algorithm(self, algorithm: Algorithm) -> None: ...
    @abstractmethod
    ...
    @abstractmethod
    async def get_average_enter_price(self, order: Order) -> float: ...
    @abstractmethod
