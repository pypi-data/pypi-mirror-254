...
def smb_copy_file(username, password, server_ip, server_name, share_name, local_file_path, remote_file_path, port):
    ...
    """
    # 建立连接
    conn = SMBConnection(username, password, username, server_name, use_ntlm_v2=True, port=139)
