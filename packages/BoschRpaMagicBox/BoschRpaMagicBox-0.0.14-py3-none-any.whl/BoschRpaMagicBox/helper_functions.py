...
def smb_copy_file(username, password, server_ip, server_name, share_name, local_file_path, remote_file_path):
...
def smb_delete_file(username, password, server_ip, server_name, share_name, remote_file_path):
    """ This function is used to copy local file to public folder
...
def smb_create_folder(username, password, server_ip, server_name, share_name, remote_folder_path):
    """ This function is used to copy local file to public folder
