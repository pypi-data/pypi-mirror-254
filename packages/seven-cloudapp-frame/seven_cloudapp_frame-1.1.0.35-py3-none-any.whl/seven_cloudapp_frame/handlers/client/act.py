...
@LastEditTime: 2024-01-31 14:54:31
...
class ActInfoHandler(ClientBaseHandler):
    ...
    def get_act_info(self):
        ...
        is_check_app_id = safe_config.get("is_check_app_id", True)
        if not act_info_dict or act_info_dict["is_del"] == 1 or (act_info_dict["app_id"] != app_id and is_check_app_id == True):
