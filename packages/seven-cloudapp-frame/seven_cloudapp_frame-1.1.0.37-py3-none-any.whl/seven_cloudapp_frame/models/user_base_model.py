...
@LastEditTime: 2024-02-02 09:26:34
...
class UserBaseModel(FrameBaseModel):
    ...
    def get_user_info_dict(self, app_id, act_id, user_id, open_id="", is_cache=True):
        ...
        if user_info_dict and SafeHelper.check_app_id(user_info_dict["app_id"], app_id) == False:
            user_info_dict = None
        return user_info_dict
    ...
    def save_user_by_openid(self, app_id, act_id, open_id, user_nick, avatar, union_id="", login_ip="", is_update_user_nick=True, mix_nick='', plat_type=0):
        ...
        try:
            ...
            if not user_info:
                ...
                if SafeHelper.check_app_id(user_info.app_id, app_id) == False:
                    invoke_result_data.success = False
    ...
    def update_user_info(self, app_id, act_id, user_id, open_id, user_nick, avatar, is_member_before=-1, is_favor_before=-1):
        ...
        try:
            ...
            if not user_info_dict:
                ...
                if SafeHelper.check_app_id(user_info_dict["app_id"], app_id) == False:
                    invoke_result_data.success = False
                    invoke_result_data.error_code = "error"
                    invoke_result_data.error_message = "非法操作"
                    return invoke_result_data
    ...
    def audit_user_black(self, app_id, black_id, audit_status, audit_remark=""):
        ...
        if not user_black:
            ...
            return invoke_result_data
        if SafeHelper.check_app_id(user_black.app_id, app_id) == False:
            invoke_result_data.success = False
            invoke_result_data.error_code = "error"
            invoke_result_data.error_message = "非法操作"
            return invoke_result_data
