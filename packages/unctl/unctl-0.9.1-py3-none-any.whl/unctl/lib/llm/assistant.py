...
class OpenAIAssistant(LanguageModel):
    ...
    def _list_assistants(self, after: Union[str, NotGiven] = NOT_GIVEN):
    ...
    async def _run_thread(
        self, thread_id: str, instructions: Union[str, NotGiven] = NOT_GIVEN
    ):
    ...
    async def initiate_session(self, data: List[str] = None):
        if data is None:
            data = []
    ...
    async def get_recommendation(
        self, session_id: str, polling_timeout: int, instructions: str = None
    ):
