...
class StaticRangePtqPreset final :
 ...
 public:
  ...
  enum : int {
    ...
    kEnablePerChannelQuantizationFieldNumber = 2,
  };
...
// bool enable_per_channel_quantization = 2;
inline void StaticRangePtqPreset::clear_enable_per_channel_quantization() {
  _impl_.enable_per_channel_quantization_ = false;
}
inline bool StaticRangePtqPreset::_internal_enable_per_channel_quantization() const {
  return _impl_.enable_per_channel_quantization_;
}
inline bool StaticRangePtqPreset::enable_per_channel_quantization() const {
  // @@protoc_insertion_point(field_get:stablehlo.quantization.StaticRangePtqPreset.enable_per_channel_quantization)
  return _internal_enable_per_channel_quantization();
}
inline void StaticRangePtqPreset::_internal_set_enable_per_channel_quantization(bool value) {
  
  _impl_.enable_per_channel_quantization_ = value;
}
inline void StaticRangePtqPreset::set_enable_per_channel_quantization(bool value) {
  _internal_set_enable_per_channel_quantization(value);
  // @@protoc_insertion_point(field_set:stablehlo.quantization.StaticRangePtqPreset.enable_per_channel_quantization)
}
