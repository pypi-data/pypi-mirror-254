...
class RobotGPTError(Exception):
    def __init__(
        ...
        super(RobotGPTError, self).__init__(message)
    ...
    def construct_error_object(self):
        ...
        return robotgpt.api_resources.error_object.ErrorObject.construct_from(
            self.json_body["error"]
        )


class APIError(RobotGPTError):
    pass


class TryAgain(RobotGPTError):
    pass


class Timeout(RobotGPTError):
    pass


class APIConnectionError(RobotGPTError):
    def __init__(
        self,
        message,
        http_body=None,
...
class InvalidRequestError(RobotGPTError):
    def __init__(
        self,
        message,
        param,
...
class AuthenticationError(RobotGPTError):
    pass


class PermissionError(RobotGPTError):
    pass


class RateLimitError(RobotGPTError):
    pass


class ServiceUnavailableError(RobotGPTError):
    pass


class InvalidAPIType(RobotGPTError):
    pass


class SignatureVerificationError(RobotGPTError):
