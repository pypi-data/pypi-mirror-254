...
class DockerAllInOne(AllInOneBase):
    ...
    def exports(self, images, path):
        self.pulls(images, lambda image: self.artifact_src.exports([image], path))
