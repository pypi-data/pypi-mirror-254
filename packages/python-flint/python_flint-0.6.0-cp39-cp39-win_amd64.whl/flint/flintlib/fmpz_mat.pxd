from flint.flintlib.flint cimport flint_rand_t, mp_bitcnt_t, ulong, slong, flint_bitcnt_t, mp_limb_t
...
# from here on is parsed
    ...
    fmpz_struct * fmpz_mat_entry(fmpz_mat_t mat, slong i, slong j)
    ...
    # void fmpz_mat_multi_mod_ui_precomp(nmod_mat_t * residues, slong nres, const fmpz_mat_t mat, fmpz_comb_t comb, fmpz_comb_temp_t temp)
    void fmpz_mat_multi_mod_ui(nmod_mat_t * residues, slong nres, const fmpz_mat_t mat)
    # void fmpz_mat_multi_CRT_ui_precomp(fmpz_mat_t mat, nmod_mat_t * const residues, slong nres, fmpz_comb_t comb, fmpz_comb_temp_t temp, int sign)
    ...
    int _fmpz_mat_mul_small(fmpz_mat_t C, const fmpz_mat_t A, const fmpz_mat_t B)
    ...
    void fmpz_mat_can_solve_fflu(fmpz_mat_t X, fmpz_t den, const fmpz_mat_t A, const fmpz_mat_t B)
    ...
    slong fmpz_mat_howell_form_mod(nmod_mat_t A, const fmpz_t mod)
