...
class GenericCRUD(metaclass=MetaLogger, object=LOGGER_CRUD_CODE_OBJECT):
    ...
    def __init__(self, *, default_schema_name: str,
        ...
        self.logger.start("GenericCRUD.__init__", object={"default_schema_name": default_schema_name,
        ...
        self.logger.end("GenericCRUD.__init__")

    def __repr__(self):
        return (f"GenericCRUD(default_schema_name={self.schema_name}, default_table_name={self.default_table_name}, "
                f"default_view_table_name={self.default_view_table_name}, default_id_column_name={self.default_column})"
                f", is_test_data={self.is_test_data}")
    ...
    def insert(self, *, schema_name: str = None, table_name: str = None, data_json: dict = None,
        ...
        if ignore_duplicate:
            self.logger.warning("Using ignore_duplicate, is it really needed?")
        ...
        try:
            ...
            if ignore_duplicate:
                self.logger.warning("Existing record found, selecting it's id")
