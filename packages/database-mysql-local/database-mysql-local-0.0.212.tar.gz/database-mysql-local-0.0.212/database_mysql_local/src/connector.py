...
class Connector(metaclass=MetaLogger, object=LOGGER_CONNECTOR_CODE_OBJECT):
    ...
    def __init__(self, schema_name: str,
        ...
        logger.start("Connector.__init__", object={
            "schema_name": schema_name, "host": host, "user": user, "password": "***"})
        self.host = host
        ...
        logger.end("Connector.__init__", object={"connections_pool": connections_pool.keys()})

    def __repr__(self):
        return f"Connector(schema_name={self.schema}, host={self.host}, user={self.user}, password=***)"
