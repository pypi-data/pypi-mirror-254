...
class OccupantHist:
    ...
    def new_track(self,sensor_id,track_id,X,Y,new_sensor_flag,num_hist_frames=10):
        ...
        if new_sensor_flag == 0:
            ...
            self.time_inactive_start[ind_s].append(dt.datetime.now(dt.UTC))
            ...
            self.time_inactive_start.append([dt.datetime.now(dt.UTC)])
        ...
        try:
            ...
            if self.tot_dist[ind_s][ind_t] > tot_dist_thresh:
                ...
                if (self.flag_active[ind_s][ind_t] == 1):
                    self.time_inactive_start[ind_s][ind_t] = dt.datetime.now(dt.UTC)
    ...
    def sensor_activity(self, sensor_id):
        ...
        if len(inactive_tracks) == 0:
            ...
            self.most_inactive_time[ind_s] = dt.datetime.now(dt.UTC) - self.time_inactive_start[ind_s][inactive_idx]
