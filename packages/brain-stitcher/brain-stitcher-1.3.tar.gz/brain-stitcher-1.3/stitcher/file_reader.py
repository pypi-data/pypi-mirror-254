import json
import numpy as np
def roiread(name, filetype: str = "OSIRIXJSON", thickness: float = 2):
    '''
...
if __name__=="__main__":
    roiread("C:/Users/Heitor Gessner/Desktop/Brain-Segmentation/Humans/Natalia F F/ext/131_220_ext_1.roi", filetype = "IMAGEJ")
