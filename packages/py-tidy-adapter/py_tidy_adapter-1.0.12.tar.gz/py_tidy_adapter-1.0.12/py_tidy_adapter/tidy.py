...
def anomaly_detection(series: 'list' = [], contamination=0.1, max_value=2,min_scores=0.5) -> '[x, y,scores]':
    scores = [
    ...
    return [[*series[r[0]],r[1]/num_detector] for r in result[:min(len(result), max_value)]]
