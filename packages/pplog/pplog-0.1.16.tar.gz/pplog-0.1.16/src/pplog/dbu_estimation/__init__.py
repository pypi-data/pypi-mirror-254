...
def estimate_dbu_usage(
    ...
    approx_job_start_timestamp: int,
    ...
    if approx_job_start_timestamp > approx_job_end_timestamp:
        raise pplog.errors.FailedToEstimateDBU(
            f"Start time '{approx_job_start_timestamp}' "
    ...
    total_elapsed_time_in_milliseconds = approx_job_end_timestamp - approx_job_start_timestamp
