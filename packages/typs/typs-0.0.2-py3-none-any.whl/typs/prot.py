...
from .cons import (ALLATTRS, CALLFNCS, )
...
from .enum import ProtocolMethod

# %% ../nbs/06_prot.ipynb 16
defprops = dict(
...
class ProtocolBaseMeta(_ProtocolMeta):
    ...
    _slots : ClassVar[dict[str, Property]]
    ...
    def __init__(self: Self, name: str, bases: tuple = tuple(), dct: dict = dict(), **kwargs):
    ...
    def makebases(cls: Type[Self], kls: Optional[T] = None) -> Types:
        ...
        bases = (kls, btype) if btype not in kls.__bases__ else (kls, )
        return bases
