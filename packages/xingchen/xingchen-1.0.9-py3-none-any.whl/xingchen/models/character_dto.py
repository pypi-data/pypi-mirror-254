...
class CharacterDTO(BaseModel):
    ...
    __properties = ["name", "avatar", "introduction", "basicInformation", "openingLine", "traits", "chatExample", "type", "chatObjective", "advancedConfig", "characterId", "version", "majorVersion", "gmtCreate", "gmtModified", "userId", "modifiedBy", "tags", "bubbles", "backgroundImgUrl", "permConfig", "versions", "manageable", "creator", "isPreConfigured"]
    ...
    def from_dict(cls, obj: dict) -> CharacterDTO:
        ...
        _obj = CharacterDTO.parse_obj({
            ...
            "advanced_config": CharacterAdvancedConfig.from_dict(obj.get("advancedConfig")) if obj.get("advancedConfig") is not None else None,
            ...
            "perm_config": CharacterPermissionConfig.from_dict(obj.get("permConfig")) if obj.get("permConfig") is not None else None,
