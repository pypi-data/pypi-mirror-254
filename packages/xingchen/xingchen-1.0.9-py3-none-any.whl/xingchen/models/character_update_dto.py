...
class CharacterUpdateDTO(BaseModel):
    ...
    __properties = ["gatewayAddContent", "name", "avatar", "introduction", "basicInformation", "openingLine", "traits", "chatExample", "type", "chatObjective", "advancedConfig", "characterId", "version", "permConfig"]
