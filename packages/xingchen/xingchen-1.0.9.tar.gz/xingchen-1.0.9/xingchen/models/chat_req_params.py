...
class ChatReqParams(BaseModel):
    ...
    __properties = ["gatewayAddContent", "botProfile", "messages", "sampleMessages", "advancedSettings",
    ...
    def from_dict(cls, obj: dict) -> ChatReqParams:
        ...
        _obj = ChatReqParams.parse_obj({
            "gateway_add_content": GatewayIssuedParams.from_dict(obj.get("gatewayAddContent")) if obj.get(
                "gatewayAddContent") is not None else None,
