...
def generate_cmdline_parser_env_gitlab(subparser):
    subparser.add_argument("--env-file", type=str, required=True, help="Output File")
    subparser.add_argument(
        "--env-version", type=str, default=exacb.metadata.semver.major, help="Output Version"
    )
...
def generate_cmdline_parser_record_generate(subparser):
    ...
    subparser.add_argument("--record", type=str, required=True, help="Output File")
    subparser.add_argument(
        "--record-version", type=str, default=exacb.metadata.semver.major, help="record Version"
    )
