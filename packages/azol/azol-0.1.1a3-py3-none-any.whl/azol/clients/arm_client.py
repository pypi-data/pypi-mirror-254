...
Typical usage example:
    ...
    client=ArmClient(tenant="tenant.com", credential_object=cred)
...
from azol.constants import ARMOAUTHRESOURCEID, ARMURL
...
class ArmClient( OAuthHTTPClient ):
    ...
    def __init__( self, *args, principal_lookup_table=None, **kwargs ):
        super().__init__( oauth_resource=ARMOAUTHRESOURCEID, base_url=ARMURL, *args, **kwargs)
