...
from azol.constants import application_map
...
class User( EntraIdCredential ):
    ...
    def __init__( self, *args, username=None, refresh_token=None,
                  spoofedApplication="AzurePowershell", client_id=None, **kwargs ):
        """
        ...
        if client_id is None:
            self._client_id = application_map[ spoofedApplication ][ "client_id" ]
