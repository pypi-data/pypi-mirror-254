...
def _fill_in_launchable_resources(
    ...
    if blocked_resources is None:
        blocked_resources = []
    for resources in task.resources:
        if hasattr(resources.cloud, "_REPR_ALIAS") and resources.cloud._REPR_ALIAS != 'GCPNextAI' and resources.cloud is not None and not _cloud_in_list(
            ...
            if hasattr(resources.cloud, "_REPR_ALIAS") and resources.cloud._REPR_ALIAS == 'GCPNextAI':
                credential_result = resources.cloud.check_credentials()
