...
class ConfigPathWidget(QWidget):
    ...
    def setup(self, config: QSettings, name: str, default: Path=None, label: str=None, mode: str="directory"):
        """
        Setup the link to a :py:class:`QSettings` instance and connect the select function to the button.
        ...
        mode : str, optional
            Choose 'file' or 'directory' as selection mode. In 'file' mode a filter can be set. The default is "directory".
        """
        self.config = config
        self.name = name
    ...
    def set_mode(self, mode: str="directory", filetypfilter: FileTypeFilter=FileTypeFilter.empty):
        """
