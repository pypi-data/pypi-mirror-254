...
class Query:
	...
	def get_database(A):from snowflake_local.engine.transform_utils import get_canonical_name as B;return A.database or A.session.database or B(DEFAULT_DATABASE,quoted=False)
@dataclasses.dataclass
