...
class QualityCheck():
    ...
    def check_qc(self,notification='disabled',user_id = ''):
        ...
        if notification !='disabled':
            ...
            content_2 = result_2
            send_card_message_user(user_id,content = content_2,title=f'Missing Value of {self.table_name}')  
            content_3 = result_3
            send_card_message_user(user_id,content = content_3,title=f'Basic Info of {self.table_name}')  
