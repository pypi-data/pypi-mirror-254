...
class BaseTask(pl.LightningModule):
    def __init__(
            ...
            predict_dataloader: Union[DataLoader, Dict] = None,
        ...
        self._predict_dataloader = self.build_dataloader(predict_dataloader)
    ...
    def predict_dataloader(self):
        """
        :return: predict dataloader (PyTorch-lightning needs)
        """
