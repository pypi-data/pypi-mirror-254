...
def train():
    ...
    if args.work_dir is not None:
        ...
        trainer_cfg['default_root_dir'] = args.work_dir
    elif trainer_cfg.get('default_root_dir', None) is None:
        # use config filename as default work_dir if cfg.work_dir is None
        trainer_cfg['default_root_dir'] = osp.join('./work_dirs', osp.splitext(osp.basename(args.config))[0])

    work_dir = trainer_cfg['default_root_dir']
