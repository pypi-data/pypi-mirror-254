...
# 数据集的根目录
train_root = '/home/yjiang/workspace/medlab/data/hymenoptera/train'
val_root = '/home/yjiang/workspace/medlab/data/hymenoptera/val'
...
train_dataloader = dict(batch_size=batch_size, num_workers=0,
                        dataset=dict(type=dataset_type, data_root=train_root, data_suffix='.jpg', subset='train',
                                     test_size=0.2, seed=1234,
                                     transforms=train_transform))
val_dataloader = dict(batch_size=batch_size, num_workers=0,
                      dataset=dict(type=dataset_type, data_root=val_root, data_suffix='.jpg', subset='val',
                                   test_size=0.2, seed=1234,
