...
class SimulationSpeedTask(SimcomplexTask):
    ...
    def run_simulation(self):
        ...
        print(f"Run simulation with speed x{self.accel:.1f}:")
...
if __name__ == '__main__':
    ...
    with local_server(config):
        ...
        task = SimulationSpeedTask(config, 5.0)
