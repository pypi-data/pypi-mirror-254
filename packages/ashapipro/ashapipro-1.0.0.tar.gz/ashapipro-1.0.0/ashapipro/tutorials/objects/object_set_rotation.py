...
from ashapi import PQ, Euler, euler2quat



class ObjectSetRotationTask(SimcomplexTask):
    ...
    def on_scene_opened(self, response):
        ...
        print(f"Now let's instantly change it's heading to 60\u00B0:")

        pq = o.pq

        o.pq = PQ(pq.p, euler2quat(Euler(60)))
    ...
    def on_object_position(self, msg):
        ...
        print(f"Now cargo01 position/orientation is:")
        geo, eul = o.geo, o.euler
        print(f'    Position in local tangent plane: ({o.pos.x:.2f}, {o.pos.y:.2f}, {o.pos.z:.2f}), (m)')
        print(f'    Orientation in local tangent plane:')
        print(f'        Heading: {eul.heading:.2f}\u00B0')
...
if __name__ == '__main__':
    ...
    with local_server(config):
        ...
        task = ObjectSetRotationTask(config, "api/all_models_nv.stexc")
