...
# [Aspose.3D for Python via .NET](https://pypi.org/project/aspose-3d/24.1.0/) (v24.1.0)
...
# [Aspose.BarCode for Python via .NET](https://pypi.org/project/aspose-barcode-for-python-via-net/24.1/) (v24.1.0)
...
# [Aspose.CAD for Python via .NET](https://pypi.org/project/aspose-cad/23.12/) (v23.12.0)
...
# [Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python/24.1.0/) (v24.1.0)
...
# [Aspose.Diagram for Python via .NET](https://pypi.org/project/aspose-diagram-python/24.1/) (v24.1.0)
...
```python
pip install aspose-diagram-python==24.1
```

# [Aspose.Email for Python via .NET](https://pypi.org/project/Aspose.Email-for-Python-via-NET/23.12/) (v23.12.0)
...
```python
pip install Aspose.Email-for-Python-via-NET==23.12
```
...
# [Aspose.OCR for Python via .NET](https://pypi.org/project/aspose-ocr-python-net/24.1.0/) (v24.1.0)
...
# [Aspose.PDF for Python via .NET](https://pypi.org/project/aspose-pdf/24.1.0/) (v24.1.0)
...
```python
pip install aspose-pdf==24.1.0
```

# [Aspose.Slides for Python via .NET](https://pypi.org/project/Aspose.Slides/24.1.0/) (v24.1.0)
...
```python
pip install Aspose.Slides==24.1.0
```

# [Aspose.Tasks for Python via .NET](https://pypi.org/project/aspose-tasks/24.1.0/) (v24.1.0)
...
# [Aspose.Words for Python via .NET](https://pypi.org/project/aspose-words/24.1.0/) (v24.1.0)
...
```python
pip install aspose-words==24.1.0
```

# [Aspose.ZIP for Python via .NET](https://pypi.org/project/aspose-zip/24.1.0/) (v24.1.0)
