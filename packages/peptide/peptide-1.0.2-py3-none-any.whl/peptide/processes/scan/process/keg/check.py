...
try:
	______peptide ["checks"] = checks;	
	______peptide ["checks found"] = True;
except Exception as E:
	print (E)
	______peptide ["checks found"] = False;
		'''

	return contents


import peptide.topics.exceptions as bs_exceptions
...
def start (find):
	...
	try:
		...
		exec (
			contents, 
			{ 
				'______peptide': ______peptide,
				'__file__': find
			}
		)
		

		if (______peptide ["checks found"] == False):
			return {
				"empty": True,
				"parsed": True
			}
