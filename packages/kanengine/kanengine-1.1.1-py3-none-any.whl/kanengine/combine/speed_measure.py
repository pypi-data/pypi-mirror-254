...
from kanengine.base.lane import LaneDetect
from ..utils.plot import PLOT


class SpeedMeasure(object):

    def __init__(self, vehicle_detector: BaseDetector, lane_detector: LaneDetect):
        self._names = vehicle_detector.names
        self._vehicle_detector = vehicle_detector
        self._lane_detector = lane_detector
        self._tracker = BYTETracker(track_thresh=0.3, match_thresh=0.7)
