                ...
                for y in range(YTileCounter):
                    ...
                    for XRoundingError in range(15):
                        for YRoundingError in range(15):
                            ...
                            XPositionWithRoundingError = xposition + (XRoundingError * 0.01)
                            YPositionWithRoundingError = yposition + (YRoundingError * 0.01)

                            XPositionWithRoundingError = round(XPositionWithRoundingError, 2)
                            YPositionWithRoundingError = round(YPositionWithRoundingError, 2)
