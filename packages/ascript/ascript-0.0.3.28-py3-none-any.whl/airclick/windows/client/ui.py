...
from aslib.windows import window
from aslib.windows.client import tools
import configparser
from aslib.windows.client.tools import EnvThread
from aslib.windows.client.worker import PkgThread, PyEnvSet
    ...
    def btn_local_apps(self):
        ...
        for f in file_list:
            ...
            with open(exe_file, 'w') as exe_bat:
                ...
                exe_bat.write(f'cmd /k "workon airclick && python {pyrun_file}"')
...
class ConfigWindow(QFrame):
    ...
    def create_item(self, file: str):
        ...
        def itme_run_click(run_btn):
            ...
            # os.system("D:\\work\\airclick_pylib\\aslib\\windows\\client\\assets\\tools\\apps\\first.bat")
