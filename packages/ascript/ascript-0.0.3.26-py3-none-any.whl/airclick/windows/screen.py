...
from airclick.windows.daos.screen import Size, Point, OcrRes
from airclick.windows.utils import screen_utils, airclickcv as aircv
import numpy as np
from airclick.windows.system import R
