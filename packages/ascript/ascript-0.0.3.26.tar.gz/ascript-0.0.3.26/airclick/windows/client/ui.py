...
from airclick.windows import window
from airclick.windows.client import tools
import configparser
from airclick.windows.client.tools import EnvThread
from airclick.windows.client.worker import PkgThread, PyEnvSet
...
class ConfigWindow(QFrame):
    ...
    def create_item(self, file: str):
        ...
        def itme_run_click(run_btn):
            ...
            # os.system("D:\\work\\airclick_pylib\\airclick\\windows\\client\\assets\\tools\\apps\\first.bat")
