...
def create_customer_domain(
    ...
    """Create new customer domain (DEV)
    ...
    :param str description: Description of the domain \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
...
def get_customer_domains(
    ...
    """Search Customer Domains with specified query params (DEV)
...
def search_customer_domain(
    ...
    """Search Customer Domains with specified criteria (DEV)
...
def unverify_customer_domain(
    ...
    """Unverifies a verified customer domain (DEV)
...
def verify_customer_domain(
    ...
    """Verifies an unverified customer domain and its subdomains (DEV)
