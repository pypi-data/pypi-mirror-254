...
def aggregate_metrics(
    ...
    :param str startTimestamp: Restrict result set to records submitted after this time.Allows unix timestamp \(milliseconds\)\, ISO timestamp\, or relative time specifies.
    :param int endTimestamp: Restrict result set to records submitted before this time. Allows unix timestamp \(milliseconds\)\, ISO timestamp\, or relative time specifies. \(default now\)
