...
- Se agregan condiciones para mejorar la imputación de distancias en *DistancesImputer*.

#### Version 0.3.7

- Se implementa la imputación de distancias con *DistancesImputer* dentro de PlantinFMCreator.
