...
my_own_macbook_locations = {'travel_img_location': (207.0, 183),
                            ...
                            "tutorial_ranger_location": (1145, 437),
...
class PixelsUser:
    def __init__(self, my_driver=None, operation_system='windows'):
        ...
        if operation_system == 'macOS':
            ...
            self.COLORS = {
                ...
                # fountain_color = (197, 141, 201) might work for the pikel statue (181, 222, 69), (75, 114, 39), (123, 183, 54),
    ...
    def initiate_new_account(self):
        with open(file='accounts.text', mode='a') as accounts_text_file:
        ...
        pyautogui.press('enter')
        sleep(7)
        create_new_account_button = self.driver.find_element(By.XPATH,
                                                             '//*[@id="__next"]/div/div[3]/div[2]/div[1]/div[2]/button[1]')
        ...
        sleep(3)
        # enter username
        # pyautogui.doubleClick(self.LOCATIONS["tutorial_username_input"])
        # pyautogui.typewrite(f'{self.username}')
        username_input = self.driver.find_element(By.TAG_NAME, 'input')
        username_input.send_keys(self.username)
        sleep(2)
        # continue button
        # pyautogui.doubleClick(self.LOCATIONS["tutorial_continue_button"])
        ...
        accept_full_xpath_button = '/html/body/div[1]/div/div[3]/div/div[2]/div/div/button'  # also has 'Accept' as text, button
        sleep(0.3)
        ...
        # click on hazel at 1422, 420
        # pyautogui.click(self.LOCATIONS["tutorial_hazel_location"])
        # sleep(0.5)
        # # skip dialog
        # self.skip_dialog()
        sleep(3)
    ...
    def press_on_color(self, target_color: tuple = (181, 211, 239), hold_duration=0.6):
