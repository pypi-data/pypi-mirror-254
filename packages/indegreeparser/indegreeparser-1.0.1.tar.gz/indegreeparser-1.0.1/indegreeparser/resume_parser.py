...
import io
from spacy.matcher import Matcher
import utils  # Make sure you have the 'utils' module with necessary functions
...
class ResumeParser(object):
    ...
    def __get_basic_details(self):
        ...
        try:
            ...
            try:
                exp = utils.get_total_experience(entities['experience'])
...
# !jupyter nbconvert --to py resume_parser.ipynb
