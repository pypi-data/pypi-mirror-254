...
class ContactGroup(GenericMapping):
    ...
    def create_and_link_new_group(self, entity_name: str, contact_id: str, title_lang_code: str, is_interest: bool):
        ...
        group_id = self.group_remote.insert_update_group(title=title, titleLangCode=title_lang_code,
    ...
    def add_update_group_and_link_to_contact(self, entity_name: str, contact_id: str,
        ...
        try:
            ...
            response = self.group_remote.get_group_by_group_name(groupName=normalized_entity_name)
            if response.status_code == 200:
            ...
            if len(groups_to_link) == 0:
                groups_linked = self.create_and_link_new_group(normalized_entity_name, contact_id, title_lang_code, is_interest)
            else:
