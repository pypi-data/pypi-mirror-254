...
class EquipeJsonldEquipe(object):
    ...
    def __init__(self, id=None, type=None, context=None, club=None, season=None, category_code=None, number=None, code=None, short_name=None, short_name_ligue=None, short_name_federation=None, type=None, engagements=None, category_label=None, category_gender=None, diffusable=None):  # noqa: E501
