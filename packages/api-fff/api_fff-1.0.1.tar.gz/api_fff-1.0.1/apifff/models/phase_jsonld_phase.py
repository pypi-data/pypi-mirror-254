...
class PhaseJsonldPhase(object):
    ...
    def __init__(self, id=None, type=None, context=None, number=None, type=None, name=None, has_ranking=None, has_second_leg=None, has_penalty=None, has_extra_time=None, competition=None, groups=None):  # noqa: E501
