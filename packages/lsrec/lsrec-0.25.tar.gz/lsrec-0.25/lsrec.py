# https://github.com/pallets/click/blob/5f75f9ec38ccf2ddac4e6b92cc07fec6d9b1b7e0/examples/imagepipe/imagepipe.py
...
def cli():
    ...
    \b
        lsrec open -i example01.jpg resize -w 128 display
        lsrec open -i example02.jpg blur save
    """
...
def list_cmd(images):
    ...
    for image in images:
        click.echo('Listying "%s"' % image.filename)
        #image.show()
        yield image
