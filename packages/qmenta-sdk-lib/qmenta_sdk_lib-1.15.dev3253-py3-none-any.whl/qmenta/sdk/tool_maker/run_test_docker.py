...
def run_docker(
    ...
    # In-container paths
    c_settings_path = "/qmenta/local_exec_settings.json"
    c_values_path = "/qmenta/local_exec_settings_values.json"
    c_input_path = "/qmenta/local_exec_input/"
    c_output_path = "/qmenta/local_exec_output/"
    c_res_path = "/qmenta/local_exec_resources/"
    ...
    run_command(
        ["docker", "exec", c_name, "/bin/bash", "-c", r"sed -i.bak 's/\<qmenta.sdk\>/&.local/' /qmenta/entrypoint.sh"],
        verbose=False,
    )
