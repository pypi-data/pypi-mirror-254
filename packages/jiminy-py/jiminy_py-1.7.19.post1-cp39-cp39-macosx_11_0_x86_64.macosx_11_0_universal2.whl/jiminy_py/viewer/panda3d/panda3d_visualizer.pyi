...
class Panda3dApp(panda3d_viewer.viewer_app.ViewerApp):
    ...
    def move_orbital_camera_task(self, task: Optional[Any] = None) -> Optional[int]: ...
    def show_floor(self, show: bool) -> None: ...
    def update_floor(self, geom: Optional[Geom] = None, show_meshes: bool = False) -> NodePath: ...
    def append_group(self, root_path: str, remove_if_exists: bool = True, scale: float = 1.0) -> None: ...
    def append_node(self, root_path: str, name: str, node: NodePath, frame: Optional[FrameType] = None) -> None: ...
    def highlight_node(self, root_path: str, name: str, enable: bool) -> None: ...
    def append_frame(self, root_path: str, name: str, frame: Optional[FrameType] = None) -> None: ...
    def append_cone(self, root_path: str, name: str, radius: float, length: float, num_sides: int = 16, frame: Optional[FrameType] = None) -> None: ...
    def append_torus(self, root_path: str, name: str, major_radius: float, minor_radius: float = 0.2, num_sides: int = 12, frame: Optional[FrameType] = None) -> None: ...
    def append_cylinder(self, root_path: str, name: str, radius: float, length: float, theta_start: float = 0.0, theta_end: float = ..., anchor_bottom: bool = False, frame: Optional[FrameType] = None) -> None: ...
    def append_arrow(self, root_path: str, name: str, radius: float, length: float, anchor_top: bool = False, frame: Optional[FrameType] = None) -> None: ...
    def append_mesh(self, root_path: str, name: str, mesh_path: str, scale: Optional[Tuple3FType] = None, frame: Optional[FrameType] = None, no_cache: Optional[bool] = None) -> None: ...
    def set_watermark(self, img_fullpath: Optional[str] = None, width: Optional[int] = None, height: Optional[int] = None) -> None: ...
    def set_legend(self, items: Optional[Sequence[Tuple[str, Optional[Sequence[int]]]]] = None) -> None: ...
    def set_clock(self, time: Optional[float] = None) -> None: ...
    def set_material(self, root_path: str, name: str, color: Optional[Tuple4FType] = None, texture_path: str = '', disable_material: Optional[bool] = None) -> None: ...
    ...
    def show_node(self, root_path: str, name: str, show: bool, always_foreground: Optional[bool] = None) -> None: ...
    ...
    def get_screenshot(self, requested_format: str = 'RGB', raw: bool = False) -> Union[np.ndarray, bytes]: ...
...
class Panda3dViewer:
    def __init__(self, window_title: str = 'jiminy', window_type: Literal['onscreen', 'offscreen'] = 'onscreen', config: Optional[Union[Dict[str, Any], ViewerConfig]] = None, **kwargs: Any) -> None: ...
    def join(self) -> None: ...
    def stop(self) -> None: ...
...
def convert_bvh_collision_geometry_to_primitive(geom: hppfcl.CollisionGeometry) -> Optional[Geom]: ...
...
class Panda3dVisualizer(BaseVisualizer):
    ...
    viewer: Incomplete
    def initViewer(self, viewer: Optional[Union[Panda3dViewer, Panda3dApp]] = None, loadModel: bool = False, **kwargs: Any) -> None: ...
    def getViewerNodeName(self, geometry_object: pin.GeometryObject, geometry_type: pin.GeometryType) -> Tuple[str, str]: ...
    def loadViewerGeometryObject(self, geometry_object: pin.GeometryObject, geometry_type: pin.GeometryType, color: Optional[np.ndarray] = None) -> None: ...
    root_name: Incomplete
    def loadViewerModel(self, root_node_name: str, color: Optional[np.ndarray] = None) -> None: ...
