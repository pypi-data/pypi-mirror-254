...
class _ProcessWrapper:
    def __init__(self, proc: Union[multiprocessing.process.BaseProcess, subprocess.Popen, Panda3dApp, Process]) -> None: ...
...
class Viewer:
    ...
    @staticmethod
    def update_floor(ground_profile: Optional[jiminy.HeightmapFunctor] = None, x_range: Tuple[float, float] = (-10.0, 10.0), y_range: Tuple[float, float] = (-10.0, 10.0), grid_unit: Tuple[float, float] = (0.04, 0.04), simplify_meshes: bool = False, show_meshes: bool = False) -> None: ...
    @staticmethod
