...
Mycroft.Delegate {
    ...
    Connections {
        ...
        onMediaStatusChanged: {
            Mycroft.MycroftController.sendRequest("ovos.common_play.media.state", {"state": status})
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            if (sessionData.uri && sessionData.isMusic && likeIcon.visible === false) {
                                ...
                                Mycroft.MycroftController.sendRequest("ovos.common_play.like", {"uri": sessionData.uri,
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                AudioPlayerControl {
                    ...
                    onClicked: {
                        Mycroft.MycroftController.sendRequest("ovos.common_play.repeat.toggle", {})
                        Mycroft.MycroftController.sendRequest("ovos.common_play.status", {})
                    }
                }
                ...
                AudioPlayerControl {
                    ...
                    onClicked: {
                        Mycroft.MycroftController.sendRequest("ovos.common_play.previous", {})
                    }
                }
                ...
                AudioPlayerControl {
                    ...
                    controlIconColor: root.currentState === MediaPlayer.PlayingState ? Kirigami.Theme.textColor : Qt.rgba(Kirigami.Theme.textColor.r, Kirigami.Theme.textColor.g, Kirigami.Theme.textColor.b, 0.4)
                    horizontalMode: root.horizontalMode
                ...
                AudioPlayerControl {
                    ...
                    onClicked: {
                        Mycroft.MycroftController.sendRequest("ovos.common_play.unlike", {"uri": sessionData.uri,
                                                   "title": sessionData.title,
                                                   "image": sessionData.image,
                                                   "artist": sessionData.artist})
                        sessionData.isLike = true
                ...
                AudioPlayerControl {
                    ...
                    onClicked: {
                        Mycroft.MycroftController.sendRequest("ovos.common_play.next", {})
                    }
                }
                ...
                AudioPlayerControl {
                    ...
                    onClicked: {
                        Mycroft.MycroftController.sendRequest("ovos.common_play.shuffle.toggle", {})
                        Mycroft.MycroftController.sendRequest("ovos.common_play.status", {})
                    }
                }
            }
