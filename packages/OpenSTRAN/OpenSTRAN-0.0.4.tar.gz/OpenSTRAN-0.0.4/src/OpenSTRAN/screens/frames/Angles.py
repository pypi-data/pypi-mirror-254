...
class Angles(tk.Frame):
	...
	# Column 1
		...
		# Define the L-Shapes Radio Button
		self.Lshape_RBtn = ttk.Radiobutton(
			self.parent,
			text = 'L-Shapes',
			variable = self.shapeType,
			value = 'L',
			command = lambda: self.updateShapeTypeList('L')
			)

		# Display the L-Shapes Radio Button
		self.Lshape_RBtn.grid(
			column = 0,
			row = 5,
			columnspan = 2,
			rowspan = 2,
		...
		# Define the 2L-Shapes Radio Button
		self._2Lshape_RBtn = ttk.Radiobutton(
			self.parent,
			text = '2L-Shapes',
			variable = self.shapeType,
			value = '2L',
			command = lambda: self.updateShapeTypeList('2L')
			)

		# Display the 2L-Shapes Radio Button
		self._2Lshape_RBtn.grid(
			column = 0,
			row = 7,
			columnspan = 2,
			rowspan = 2,
	...
	# Column 6
		...
		# Set the default selection to 'L-Shapes'
		self.shapeType.set('L')
		self.updateShapeTypeList('L')
