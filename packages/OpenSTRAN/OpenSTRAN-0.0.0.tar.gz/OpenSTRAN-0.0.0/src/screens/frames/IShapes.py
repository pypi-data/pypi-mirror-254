...
class IShapes(tk.Frame):
	...
	# Column 1
		...
		# Define the W-Shapes Radio Button
		self.Wshape_RBtn = ttk.Radiobutton(
			self.parent,
			text = 'W-Shapes',
			variable = self.shapeType,
			value = 'W',
			command = lambda: self.updateShapeTypeList('W')
			)

		# Display the W-Shapes Radio Button
		self.Wshape_RBtn.grid(
			column = 0,
			row = 5,
			columnspan = 2,
			rowspan = 2,
		...
		# Define the M-Shapes Radio Button
		self.Mshape_RBtn = ttk.Radiobutton(
			self.parent,
			text = 'M-Shapes',
			variable = self.shapeType,
			value = 'M',
			command = lambda: self.updateShapeTypeList('M')
			)

		# Display the M-Shapes Radio Button
		self.Mshape_RBtn.grid(
			column = 0,
			row = 7,
			columnspan = 2,
			rowspan = 2,
		...
		# Define the S-Shapes Radio Button
		self.Sshape_RBtn = ttk.Radiobutton(
			self.parent,
			text = 'S-Shapes',
			variable = self.shapeType,
			value = 'S',
			command = lambda: self.updateShapeTypeList('S')
			)

		# Display the S-Shapes Radio Button
		self.Sshape_RBtn.grid(
			column = 0,
			row = 9,
			columnspan = 2,
			rowspan = 2,
		...
		# Define the HP-Shapes Radio Button
		self.HPshape_RBtn = ttk.Radiobutton(
			self.parent,
			text = 'HP-Shapes',
			variable = self.shapeType,
			value = 'HP',
			command = lambda: self.updateShapeTypeList('HP')
			)

		# Display the HP-Shapes Radio Button
		self.HPshape_RBtn.grid(
			column = 0,
			row = 11,
			columnspan = 2,
			rowspan = 2,
	...
	# Column 3
		...
		# Define the Flange Thickness Label
		self.tf_Lbl = ttk.Label(
			sctnProp_Frame,
			text = 'Flange Thickness, tf'
			)

		# Display the Flange Thickness Label
		self.tf_Lbl.grid(
			column = 3,
			row = 10,
			columnspan = 2,
	...
	# Column 4
		...
		# Define the Flange Thickness Variable
	...
	# Column 6
		...
		# Set the default selection to 'W-Shapes'
		self.shapeType.set('W')
		self.updateShapeTypeList('W')
	...
	def updateShapeTypeList(self, shapeType):
		...
		# collect the relevant steel section labels by type ('W', 'S', etc.)
