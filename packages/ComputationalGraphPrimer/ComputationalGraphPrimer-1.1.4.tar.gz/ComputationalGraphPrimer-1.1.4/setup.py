...
setup(name='ComputationalGraphPrimer',
      ...
      url='https://engineering.purdue.edu/kak/distCGP/ComputationalGraphPrimer-1.1.4.html',
      download_url='https://engineering.purdue.edu/kak/distCGP/ComputationalGraphPrimer-1.1.4.tar.gz',
