...
setuptools.setup(
    name=PACKAGE_NAME,
    version='0.0.107',  # https://pypi.org/project/logger-local/
    author="Circles",
    ...
    install_requires=[
        ...
        'haggis',
        'logzio-python-handler>=4.1.1',  # https://pypi.org/project/logzio-python-handler/'
        'user-context-remote>=0.0.21',
        'python-sdk-local>=0.0.27'
    ],
    # TODO: see reqirements.txt
    dependency_links=['git+https://github.com/akiva-skolnik/logzio-python-handler.git@master']
)
