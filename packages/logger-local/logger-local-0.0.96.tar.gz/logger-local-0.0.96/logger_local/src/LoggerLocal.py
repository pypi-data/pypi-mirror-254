...
class Logger(logging.Logger):
    ...
    def start(self, log_message=None, **kwargs):
        self.__log(function=logging.debug, message_severity=MessageSeverity.Start, log_message=log_message, **kwargs)

    def end(self, log_message=None, **kwargs):
        self.__log(function=logging.debug, message_severity=MessageSeverity.End, log_message=log_message, **kwargs)
    ...
    def insert_to_payload_extra_vars(self, **kwargs):
        self.user_context = None # TODO UserContext.login_using_user_identification_and_password()
