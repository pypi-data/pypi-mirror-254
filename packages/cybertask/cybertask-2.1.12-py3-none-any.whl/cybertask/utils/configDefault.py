...
defaultSettings = (
    ...
    ('systemMessage_chatgpt', 'You are a helpful assistant.'), # system message for standalone gpt chatgpt
    ('systemMessage_geminipro', 'You are a helpful assistant.'), # system message for standalone geminipro chatgpt
    ('systemMessage_palm2', 'You are a helpful assistant.'), # system message for standalone palm2 chatgpt
    ('systemMessage_codey', 'You are an expert on coding.'), # system message for standalone codey chatgpt
