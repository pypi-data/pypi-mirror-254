...
_fil_navn_src = __._primtall_ja_nei_intervall_src_py
...
# python /Users/krj/Desktop/program/src/_dir_1/bld/data_fil/_exe/python/programmer/matematikk/tallteori/primtall/primtall_ja_nei_intervall_1.py
...
{_._c_verdier_L}
{_._v_min} = {_._e_primtall_ja_nei_intervall_val_1}
{_._v_max} = {_._e_primtall_ja_nei_intervall_val_2}
	...
	for {_._v_n} in range(int({_._v_min}), int({_._v_max}) + 1):
		...
		if {_._v_n} > 1:
			...
			for {_._v_i} in range(2, int({_._v_n} / 2) + 1):
				...
				if {_._v_n} % {_._v_i} == 0:
					print(f"{_._r_Er} {{n}} {_._r_et_primtall}{_._v_question} {_._r_Nei}")
					break
