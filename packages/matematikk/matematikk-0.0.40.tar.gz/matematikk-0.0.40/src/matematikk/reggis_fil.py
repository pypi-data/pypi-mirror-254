...
def reggis(variabel = Symbol(""),
    ...
    # - Importerer numpy og polyfit(), sympy og Symbol()
    ...
    # Oppdaterer polynomet med navnet
    return _uttrykk
...
reggis_cas                  = reggis
regregsjon                  = reggis
regregsjon_cas              = reggis
regregsjon_polynom          = reggis
regregsjon_polynom_cas      = reggis

# Syntax > Reversed
cas_regresjon               = reggis
cas_regregsjon_polynom      = reggis
regregsjon_polynom_cas      = reggis