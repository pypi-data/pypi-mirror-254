...
_fil_navn_src = __._fibonacci_formel_n_rekursiv_src_py
...
# python /Users/krj/Desktop/program/src/_dir_1/bld/data_fil/_exe/python/programmer/matematikk/tallteori/fibonacci_tall/fibonacci_formel_n_rekursiv_1.py
...
{_._c_input}
{_._v_n} = {_._e_fibonacci_formel_n_rekursiv_val}
...
def {_._f_fibonacci_n_rekursiv}({_._v_n}):
	...
	else: return {_._f_fibonacci_n_rekursiv}({_._v_n} - 1) + {_._f_fibonacci_n_rekursiv}({_._v_n} - 2)
