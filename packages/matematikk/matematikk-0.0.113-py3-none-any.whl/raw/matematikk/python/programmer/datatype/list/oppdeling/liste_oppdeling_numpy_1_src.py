...
_fil_navn_src = __._liste_oppdeling_numpy_src_py
...
# python /Users/krj/Desktop/program/src/_dir_1/bld/data_fil/_exe/python/programmer/datatype/list/oppdeling/liste_oppdeling_numpy_1.py
...
def {_._f_oppdeling_lister_numpy}({_._v_liste}):
    ...
    {_._v_del_arr_plur} = np.array_split({_._v_liste}, {_._v_steg})
