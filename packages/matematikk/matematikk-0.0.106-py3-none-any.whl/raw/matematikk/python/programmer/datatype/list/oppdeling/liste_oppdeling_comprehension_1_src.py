...
_fil_navn_src = __._liste_oppdeling_comprehension_src_py
...
# python /Users/krj/Desktop/program/src/_dir_1/bld/data_fil/_exe/python/programmer/datatype/list/oppdeling/liste_oppdeling_comprehension_1.py
...
{_._c_verdier_L}
{_._v_n_deler} = {_._e_list_oppdeling_n_for_val}
{_._v_liste}   = {_._e_list_oppdeling_arr}

{_._c_fn_oppdeling_lister_core}
def {_._f_oppdeling_lister_comprehension}({_._v_liste}):
...
{_._v_del_arr_plur} = {_._f_oppdeling_lister_comprehension}({_._v_liste})
