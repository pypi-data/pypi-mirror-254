...
_fil_navn_src = __._fibonacci_ja_nei_n_input_src_py
...
# python /Users/krj/Desktop/program/src/_dir_1/bld/data_fil/_exe/python/programmer/matematikk/tallteori/fibonacci_tall/fibonacci_ja_nei_n_2_input.py
...
def {_._f_er_fibonacci_tall_print}({_._v_n}):

    {_._c_print_legacy}
    if {_._f_er_fibonacci_tall}(int({_._v_n})) == True: print(f"{_._r_Er} {{{_._v_n}}} {_._r_et_fibonacci_tall}{_._v_question} {_._r_Ja}")
