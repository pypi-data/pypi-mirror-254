...
_fil_navn_src = __._liste_oppdeling_for_input_str_src_py
...
# python /Users/krj/Desktop/program/src/_dir_1/bld/data_fil/_exe/python/programmer/datatype/list/oppdeling/liste_oppdeling_for_2_input_str.py
...
def {_._f_oppdeling_lister_for_loop}({_._v_liste}):
    ...
    for {_._v_i} in range({_._v_start}, {_._v_slutt}, int({_._v_steg})):
        {_._v_del_arr_plur}.append({_._v_liste}[{_._v_i} : {_._v_i} + int({_._v_steg})])
