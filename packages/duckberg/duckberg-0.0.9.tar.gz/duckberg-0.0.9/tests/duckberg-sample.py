...
db = DuckBerg(catalog_name=catalog_name, catalog_config=catalog_config, database_names=["nyc"])
...
query: str = (
    "SELECT count(*) FROM (SELECT * FROM 'nyc.taxis' WHERE trip_distance > 40 ORDER BY tolls_amount DESC)"
)
