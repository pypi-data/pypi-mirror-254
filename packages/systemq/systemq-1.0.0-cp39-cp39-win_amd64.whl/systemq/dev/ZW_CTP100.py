from .common import BaseDriver, QInteger, QBool, QReal, QString
try:
    from .common.ZWD_DDS import ZW_CTP100_Dev as clk_fout_dev
except:
...
class Driver(BaseDriver):
    ...
    quants = [
        ...
        QString('TriggerSource', ch=1, value='Single shot external rising edges'),
        QInteger('TRIG', ch=1), # 触发开始命令
        QString('TriggerMode', ch=1, value='Burst'), # 在触发设置的最后，其余变量都是缓存，当triggermode设置的时候会真正刷新机器的触发设置。
