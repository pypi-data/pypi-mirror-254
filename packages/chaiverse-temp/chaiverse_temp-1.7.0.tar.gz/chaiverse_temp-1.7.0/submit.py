...
class ModelSubmitter:
    ...
    def _preprocess_submission(self, submission_params):
        submission_params["formatter"] = submission_params["formatter"].dict() if submission_params.get("formatter") else None
        submission_params["reward_formatter"] = submission_params["reward_formatter"].dict() if submission_params.get("reward_formatter") else None
