...
class MetricServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Matching = channel.unary_unary(
                '/connector.metric.MetricService/Matching',
                request_serializer=metric__pb2.MetricMatchingRequest.SerializeToString,
                response_deserializer=metric__pb2.MetricMatchingResponse.FromString,
                )
...
class MetricServiceServicer(object):
    ...
    def Matching(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MetricServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Matching': grpc.unary_unary_rpc_method_handler(
                    servicer.Matching,
                    request_deserializer=metric__pb2.MetricMatchingRequest.FromString,
                    response_serializer=metric__pb2.MetricMatchingResponse.SerializeToString,
            ),
    }
...
class MetricService(object):
    ...
    def Matching(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/connector.metric.MetricService/Matching',
            metric__pb2.MetricMatchingRequest.SerializeToString,
            metric__pb2.MetricMatchingResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
