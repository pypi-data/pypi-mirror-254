...
def main(pr_file_path: str, report_file_path: str, output_file: str, modification_of_interests: str, columns: str):
    process_diann_ptm(pr_file_path, report_file_path, output_file, modification_of_interests, columns=columns)
