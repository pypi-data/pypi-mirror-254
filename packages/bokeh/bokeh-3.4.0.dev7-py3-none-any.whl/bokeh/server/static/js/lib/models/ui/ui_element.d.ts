...
declare const StyleSheets: import("../../core/kinds").Kinds.Array<string | BaseStyleSheet | import("../../core/types").DictLike<Styles | import("../../core/types").DictLike<string | null>>>;
