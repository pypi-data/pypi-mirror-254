...
export declare function clone<T>(obj: DictLike<T>): DictLike<T>;
export declare function merge<K, V>(obj0: Map<K, Arrayable<V>>, obj1: Map<K, Arrayable<V>>): Map<K, V[]>;
export declare function size(obj: DictLike<unknown>): number;
export declare function is_empty(obj: DictLike<unknown>): boolean;
export declare class MapProxy<V> implements Map<string, V> {
    readonly obj: {
        [key: string]: V;
    };
    constructor(obj: {
...
export declare function dict<V>(obj: DictLike<V>): Map<string, V>;
