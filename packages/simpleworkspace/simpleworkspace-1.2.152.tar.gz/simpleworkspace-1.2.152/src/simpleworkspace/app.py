...
class App:
    ...
    def Setup(cls, name: str, company: str = None, id: str = None):
        ...
        cls.path_AppData_Storage = _os.path.join(cls.path_AppData, "storage")
        ...
        cls.logger = RotatingFileLogger.GetLogger(_os.path.join(cls.path_AppData, "app.log"), registerGlobalUnhandledExceptions=True)
        cls.settingsManager = SettingsManager_JSON(_os.path.join(cls.path_AppData, "config.json"))
