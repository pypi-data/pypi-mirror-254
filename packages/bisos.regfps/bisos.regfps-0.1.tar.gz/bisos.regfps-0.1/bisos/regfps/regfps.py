...
####+BEGIN: b:py3:cs:method/typing :methodName "nextNu" :deco ""
    """ #+begin_org
**  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Mtd-T-     [[elisp:(outline-show-subtree+toggle)][||]] /nextNu/   [[elisp:(org-cycle)][| ]]
    #+end_org """
    def nextNu(
####+END:
            self,
...
####+END:
        ...
        if b.subProc.WOpW(invedBy=self, log=1).bash(
                f"""echo {fpsBase} | bx-gitRepos -i gitRemPull""",
...
####+END:
        ...
        if b.subProc.WOpW(invedBy=self, log=1).bash(
                f"""echo {fpsBase} | bx-gitRepos -i addCommitPush all""",
        ).isProblematic():  return(b_io.eh.badOutcome(cmndOutcome))
...
####+BEGIN: b:py3:cs:method/typing :methodName "unitFind" :deco ""
    """ #+begin_org
**  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Mtd-T-     [[elisp:(outline-show-subtree+toggle)][||]] /unitFind/   [[elisp:(org-cycle)][| ]]
    #+end_org """
    def unitFind(
####+END:
            self,
