...
class YunXiao:
    ...
    def renew_auth(self):
        ...
        with requests.Session() as client:
            ...
            headers["x3-authentication"] = client.get(
            ...
            weboauth2 = client.get(url=weblogin.json()["data"], allow_redirects=False)
            webcode = client.get(url=weboauth2.headers["location"], allow_redirects=False)
            webtoken = client.get(url=webcode.headers["location"], allow_redirects=False)
