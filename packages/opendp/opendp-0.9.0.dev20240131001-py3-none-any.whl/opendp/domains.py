...
def atom_domain(
    ...
    [atom_domain in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240131.1/opendp/domains/fn.atom_domain.html)
...
def option_domain(
    ...
    [option_domain in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240131.1/opendp/domains/fn.option_domain.html)
