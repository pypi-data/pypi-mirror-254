...
if __name__ == "__main__":
    ...
    # Generate output CSV
    emissions_df.to_csv(
        '/home/ngomariz/LEZ-cities/lindau/test_emission.csv', float_format='%.6f', index=False
    )

    # # Generate output CSVs
    # for pollutant_name, dataframe in emisions_dataframes.items():
    #     filename = f"link_hot_{pollutant_name}_emissions.csv"
    #     dataframe.to_csv(filename, float_format='%.6f', index=False)
