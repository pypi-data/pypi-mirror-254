...
class QuantumCircuit:
	...
	def get_system_code(self, **kwargs):
		...
		self.system_code["initial_mapping"] = {k: v for k, v in self.system_code["initial_mapping"].items()}
		self.system_code["final_mapping"] = {v: k for k, v in self.inverse_mapping_table.items()}
