...
from utils import get_utc_timestamp, decode_dict, decode_int, decode_data
from xian_formating import format_dictionary, check_format_of_payload
from xian_encoding import encode, decode
...
def create_tx(
    ...
    tx = {
        "payload": payload,
        "metadata": {
            "signature": wallet.sign_msg(encode(decode(encode(payload)))),
