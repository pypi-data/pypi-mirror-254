...
class Xian:
    ...
    def approve(
            ...
            contract: str,
            token: str = "currency",
            amount: int | float | str = 1000000000000) -> tuple[bool, str]:
        """ Approve smart contract to spend max token amount """

        kwargs = {"amount": amount, "to": contract}
        return self.send_tx(token, "approve", kwargs, 50)
    ...
    def deploy_contract(
            ...
            name: str,
            code: str,
            stamps: int = 1000) -> tuple[bool, str]:
        """
