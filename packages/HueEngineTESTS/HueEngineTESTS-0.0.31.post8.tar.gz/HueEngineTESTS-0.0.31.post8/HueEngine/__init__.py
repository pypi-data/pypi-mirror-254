...
def makeEntity(*component_s:_TYPE[_COMPONENT]|_ARRAY[_TYPE[_COMPONENT]]) -> int:
    ...
    for componentInstance in component_s:
        ...
        _freeCache()
    addComponent(e, WorldSpaceComponent())
    if (not _ENTITIES[e].__contains__(TransformComponent)): addComponent(e,TransformComponent(100,100))
    return e
...
def init():
    ...
    addProcessor(PhysicsProcessor(), 3)
