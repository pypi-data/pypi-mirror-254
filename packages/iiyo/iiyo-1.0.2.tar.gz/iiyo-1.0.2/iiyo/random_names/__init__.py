...
file = full_path("male_first_names.txt")
print(file)
male_names_file = name_array(file)

file = full_path("female_first_names.txt")
female_names_file = name_array(file)

file = full_path("last_names.txt")
last_names_file = name_array(file)

file = full_path("home_address.txt")
home_address_file = name_array(file)

file = full_path("city.txt")
