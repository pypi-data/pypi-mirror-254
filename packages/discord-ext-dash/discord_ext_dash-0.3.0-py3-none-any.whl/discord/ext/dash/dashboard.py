...
from .errors import DublicateRoute, InvalidAuthorization, RouteNotFound
...
class Dashboard:
    ...
    def route(self, func):
        if func.__name__ in self.route.keys():
            raise DublicateRoute("that route already exists")
        self.route[func.__name__] = func
    ...
    async def process_request(self, message):
        ...
        return {"error": False, "message": "Request processed succcessfully"}