...
class JointMotion(JointWaypointMotion):
    def __init__(self, target: numpy.ndarray[numpy.float64[7, 1]], reference_type: ReferenceType = ..., relative_dynamics_factor: float | RelativeDynamicsFactor = 1.0, return_when_finished: bool | Condition = True) -> None:
        ...
