...
class P2CP:
    ...
    def add_edge_kwargs(self, tag: Optional[Hashable] = None, **edge_kwargs):
        """
    ...
    def reset_edges(self, tag: Optional[Hashable] = None):
        """
    ...
    def to_json(self) -> str:
        ...
        collated_output = dict(axes=axis_node_dict, edges=new_dict)
