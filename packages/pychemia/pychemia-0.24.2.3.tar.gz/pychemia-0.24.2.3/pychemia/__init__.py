...
spec = importlib.util.find_spec("pyxtal")
HAS_PYXTAL = spec is not None
...
def info():
    ...
    for modui in ['numpy', 'scipy', 'spglib', 'matplotlib', 'pymongo', 'psutil', 'netCDF4',
                  'pytest', 'coverage', 'pyhull', 'pymatgen',
                  'networkx', 'ase', 'mayavi', 'qmpy', 'pyxtal' ]:
        if modui == 'numpy':
