...
set_target_properties(urdfdom::urdfdom_model PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liburdfdom_model.4.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/liburdfdom_model.4.0.dylib"
  )

list(APPEND _cmake_import_check_targets urdfdom::urdfdom_model )
list(APPEND _cmake_import_check_files_for_urdfdom::urdfdom_model "${_IMPORT_PREFIX}/lib/liburdfdom_model.4.0.dylib" )
...
set_target_properties(urdfdom::urdfdom_world PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "console_bridge::console_bridge;tinyxml2::tinyxml2"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liburdfdom_world.4.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/liburdfdom_world.4.0.dylib"
  )

list(APPEND _cmake_import_check_targets urdfdom::urdfdom_world )
list(APPEND _cmake_import_check_files_for_urdfdom::urdfdom_world "${_IMPORT_PREFIX}/lib/liburdfdom_world.4.0.dylib" )
...
set_target_properties(urdfdom::urdfdom_sensor PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "console_bridge::console_bridge;tinyxml2::tinyxml2"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liburdfdom_sensor.4.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/liburdfdom_sensor.4.0.dylib"
  )

list(APPEND _cmake_import_check_targets urdfdom::urdfdom_sensor )
list(APPEND _cmake_import_check_files_for_urdfdom::urdfdom_sensor "${_IMPORT_PREFIX}/lib/liburdfdom_sensor.4.0.dylib" )
...
set_target_properties(urdfdom::urdfdom_model_state PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "console_bridge::console_bridge;tinyxml2::tinyxml2"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liburdfdom_model_state.4.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/liburdfdom_model_state.4.0.dylib"
  )

list(APPEND _cmake_import_check_targets urdfdom::urdfdom_model_state )
list(APPEND _cmake_import_check_files_for_urdfdom::urdfdom_model_state "${_IMPORT_PREFIX}/lib/liburdfdom_model_state.4.0.dylib" )
