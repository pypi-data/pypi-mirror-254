...
def process_instruction_code(llm, sandbox, shape, instruction, line, prev_data, store):
...
def process_line(llm, sandbox, line, shape, store):
    prev_data = None
    ...
    for instruction in shape.instructions:
        ...
        if mode == Modes.LLM:
            ...
            output = process_instruction_code(
                llm, sandbox, shape, instruction, line, prev_data, store
            )
