...
setup(
  name = 'discogs_scraper',         # How you named your package folder (MyLib)
  ...
  download_url = 'https://github.com/casperUoS/discogs-Scraper/archive/refs/tags/0.1.tar.gz',    # I explain this later on
