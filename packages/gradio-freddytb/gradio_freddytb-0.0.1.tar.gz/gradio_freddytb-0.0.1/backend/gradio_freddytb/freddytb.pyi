...
class FreddyTb(Component):
    ...
    def __init__(
        ...
        *,
        ...
        """
        Parameters:
            value: A path or URL for the default value that FreddyTb component is going to take. If callable, the function will be called whenever the app loads to set the initial value of the component.
