...
from .exception import (FlowModelNotFound, ModelNotFound, ReturnModelNotFound,
                        TransitionNotAllowed)
from .middleware import get_current_user
from .models import (Action, Flowmodel, SignList, TransitionManager,
                     workevents, workflowitems)
...
class FinFlotransition:
    ...
    def __post_init__(self):
        ...
        self.current_user = self.event_user_obj if self.event_user_obj else get_current_user()
