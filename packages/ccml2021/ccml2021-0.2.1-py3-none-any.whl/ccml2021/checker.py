...
def basic3_1():
    do_variables_exist(["X_train_scaled", "y_train_scaled", "X_test_scaled", "pls_model", "y_test_pred", "pls_model_grid", "y_test_pred_grid", "svr_model_grid", "y_test_pred_svr", "y_test_pred_rf", "y_test_pred_rf500"])
