...
class PetArray[T]:
	...
	def contains(self, query: T | dict) -> bool:
		"""
	...
	def exists(self, query: T | dict) -> bool:
	...
	def update(self, update: dict, query: dict = None) -> Self:
		...
		if query is not None and not isinstance(query, dict):
			raise QueryException("Invalid query: it should be a dict")
		for doc in self._data:
	...
	def update_one(self, update: dict, query: dict = None) -> Self:
	...
	def groupby(self, key: str | int | Iterable[str | int] = None) -> PetArray:
		"""
