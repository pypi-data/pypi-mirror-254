...
class PetUtils:
	...
	@classmethod
	def match(cls, obj: dict, query: dict | Callable[[Any], bool]) -> bool:
	...
	@classmethod
	def exists(cls, obj: dict, query: dict | Callable[[Any], bool]) -> bool:
		if isinstance(query, Callable):
			return query(obj)
		elif not isinstance(query, dict):
			return obj == query
	...
	@classmethod
	def get(cls, obj: dict, key: str | int | Callable[[Any], bool] = None, fill_path: bool = False):
		if key is None:
			if obj is None:
				return NON_EXISTENT
			return obj
