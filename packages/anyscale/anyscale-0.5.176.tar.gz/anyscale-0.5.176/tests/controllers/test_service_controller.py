...
def test_rollback_v2_api(mock_auth_api_client):
    ...
    service_controller.api_client.rollback_service_api_v2_services_v2_service_id_rollback_post.assert_called_once_with(
        "service2_abc123",
        rollback_service_model=RollbackServiceModel(max_surge_percent=None),
    )


def test_rollback_max_surge_percent(mock_auth_api_client):
    """Test that rollback crafts RollbackServiceModel correctly."""
    service_controller = ServiceController()
    ...
    service_controller.api_client.rollback_service_api_v2_services_v2_service_id_rollback_post.reset_mock()
    ...
    service_controller.api_client.rollback_service_api_v2_services_v2_service_id_rollback_post.assert_called_once_with(
        "service2_abc123",
        rollback_service_model=RollbackServiceModel(max_surge_percent=43),
    )
