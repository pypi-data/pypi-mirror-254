...
class ServiceController(BaseController):
    ...
    @property
    def external_api_client(self) -> ExternalApi:
    ...
    def _get_maximum_uptime_minutes(self, service: ProductionJob) -> Optional[int]:
        compute_config: ComputeTemplate = self.internal_api_client.get_compute_template_api_v2_compute_templates_template_id_get(
    ...
    def _read_service_config_file(self, service_config_file: str) -> ServiceConfig:
        ...
        config_dict = populate_unspecified_cluster_configs_from_current_workspace(
            config_dict, self.external_api_client, populate_name=True
        )
    ...
    def rollout(  # noqa: PLR0913
        ...
        service = self.internal_api_client.apply_service_api_v2_services_v2_apply_put(
            service_v2_config
        ).result
        ...
        if "applications" in ray_serve_config:
            for ray_serve_app_config in ray_serve_config["applications"]:
                ray_serve_app_config["runtime_env"] = override_runtime_env_config(
                    ...
                    anyscale_api_client=self.external_api_client,
    ...
    def rollback(
        ...
        service = self.internal_api_client.rollback_service_api_v2_services_v2_service_id_rollback_post(
            service_id,
    ...
    def terminate(self, service_id: str) -> None:
        self.internal_api_client.terminate_service_api_v2_services_v2_service_id_terminate_post(
            service_id
        )
