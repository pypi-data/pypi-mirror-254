...
@app.callback()
def collections_callback(arlas_configuration: str = typer.Argument(help="Name of the ARLAS configuration to use from your configuration file ({})".format(configuration_file))):
