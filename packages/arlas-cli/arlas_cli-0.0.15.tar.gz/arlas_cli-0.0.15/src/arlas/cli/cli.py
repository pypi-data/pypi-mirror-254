...
def list_configurations():
    ...
    return list(Configuration.settings.arlas.keys())


@app.callback()
def collections_callback(
    arlas_configuration: str = typer.Argument(autocompletion=list_configurations, help="Name of the ARLAS configuration to use from your configuration file ({})".format(configuration_file)),
