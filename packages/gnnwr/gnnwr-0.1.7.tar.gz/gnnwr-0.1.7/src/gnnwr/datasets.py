...
def init_dataset(data, test_ratio, valid_ratio, x_column, y_column, spatial_column=None, temp_column=None,
    ...
    train_dataset.dataloader = DataLoader(
        train_dataset, batch_size=batch_size, num_workers=4, pin_memory=False, persistent_workers=True, shuffle=shuffle)
    val_dataset.dataloader = DataLoader(
        val_dataset, batch_size=max_val_size, num_workers=4, pin_memory=False, persistent_workers=True, shuffle=shuffle)
    test_dataset.dataloader = DataLoader(
        test_dataset, batch_size=max_test_size, num_workers=4, pin_memory=False, persistent_workers=True, shuffle=shuffle)
