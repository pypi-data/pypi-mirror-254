...
class PASSLEAF(Model):
    ...
    def score_func(self, head_emb, relation_emb, tail_emb, mode):
        ...
        The formula for calculating the score of DistMult is :math:`\transpose{h} \operatorname{diag}(r) t`.

        The formula for calculating the score of ComplEx is :math:` \Re(\transpose{h} \operatorname{diag}(r) \overline{t})`.
