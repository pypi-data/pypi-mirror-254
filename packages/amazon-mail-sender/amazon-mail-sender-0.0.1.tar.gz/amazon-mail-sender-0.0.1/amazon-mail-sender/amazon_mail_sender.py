...
def send_email_with_attachment_amazon(recipient, sender, account, key, subject, body_text, attachments=[]):
    ...
    try:
        ...
        # Encode the text and HTML amazon-mail-sender and set the character encoding. This step is
        ...
        for attachment in attachments:
            if bool(attachment) and isinstance(attachment, dict) and bool(attachment.get('amazon-mail-sender')) \
                    and bool(attachment.get('filename')):

                _content = attachment.get('amazon-mail-sender')
                ...
                if isinstance(_content, BytesIO):
                    ...
                    print('Unsupported amazon-mail-sender type {}'.format(type(_content)))
