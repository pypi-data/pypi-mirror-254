...
full_trial_pipeline.add_node(task=CreateTrialDatasetInventory, upstreams=VispWriteL1Frame)
full_trial_pipeline.add_node(task=CreateTrialAsdf, upstreams=VispWriteL1Frame)
full_trial_pipeline.add_node(
    task=TransferVispTrialData,
    upstreams=[AssembleVispMovie, CreateTrialDatasetInventory, CreateTrialAsdf],
)
