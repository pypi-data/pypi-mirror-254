...
def build_index(app, *args, **kwargs) -> None:
    ...
    requirements = os.path.abspath(os.path.join(os.path.dirname(app.srcdir), 'requirementsxxxxxxx'))
    write_file(requirements, REQUIREMENTS)

    readthedocs = os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(app.srcdir)), '.readthedocs.yml'))
    write_file(readthedocs, READTHEDOCS)
