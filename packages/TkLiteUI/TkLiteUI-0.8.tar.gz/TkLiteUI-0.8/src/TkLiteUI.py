...
class ui:
    ...
    def create_window(self, **kwargs):
        """
            ...
            bg (str, opsiyonel): Pencerenin arka plan rengi. Varsayılan değer 'white'.
            ...
            pencere = create_window(width=500, height=400, title="Merhaba TkLiteUI", bg='light blue')

            # Detaylı özelliklere sahip pencere oluşturma
            pencere = create_window(width=600, height=500, title="Merhaba TkLiteUI", bg='light grey',
