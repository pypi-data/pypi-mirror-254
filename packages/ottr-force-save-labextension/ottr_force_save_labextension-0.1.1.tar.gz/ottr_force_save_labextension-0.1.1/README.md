...
```bash
pip install ottr_force_save_labextension
```
...
```bash
pip uninstall ottr_force_save_labextension
```
...
# Change directory to the ottr_force_save_labextension directory
...
folder is located. Then you can remove the symlink named `ottr-force-save-labextension` within that folder.
