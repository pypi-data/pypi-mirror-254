...
class ModelViewSet(RestModelViewSet):
    ...
    def _get_pk(request) -> Any:
        ...
        """
        # TODO: Validar que el dict no sea vacío.
    ...
    def _create(self, request, *args, **kwargs) -> Response:
        ...
        **kwargs: Dictionary with key, value parameter
        ...
        try:
            ...
            # TODO: Validar error al invocar APIException
    ...
    def _update(self, request, *args, **kwargs) -> Response:
        ...
        **kwargs: Dictionary with key, value parameter
        ...
        try:
            ...
            # TODO: Validar error en la obtención del exc.detail.get("message"), exc.detail.get("detail")
            raise APIException(exc.detail.get("message"), exc.detail.get("detail"), exc.status_code) from exc
        except Exception as exc:
            logging.error(str(exc))
            logging.debug(traceback.format_exc())
