...
from zibanu.django.auth.api.serializers.profile import ProfileExtendedSerializer
...
class EmailTokenObtainSerializer(TokenObtainSerializer):
    ...
    def validate(self, attrs: Dict[str, Any]) -> Dict[Any, Any]:
        ...
        # Get avatar
        if hasattr(user, "profile"):
            profile_serializer = ProfileExtendedSerializer(instance=user.profile)
            data["avatar"] = profile_serializer.data.get("avatar")
            data["settings"] = profile_serializer.data.get("app_settings")
        return data
