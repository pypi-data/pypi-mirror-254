...
class PwcSignals:
    ...
    def square_pulse_pwc(
        ...
        *,
        ...
        segmentation = validate_enum(SegmentationType, segmentation)
        if segmentation == SegmentationType.UNIFORM:
    ...
    def gaussian_pulse_pwc(
        ...
        *,
        ...
        def create_gaussian(center_parameter):
            ...
            gaussian = amplitude * self._graph.exp(
                -(shifted_time**2) / (2 * width**2)
            )
            if drag is None:
                return gaussian
