...
from qctrlcommons.preconditions import check_numeric_numpy_array
...
def _create_flexible_binary_node_data(
    ...
    op_name: str,
    x: Union[float, complex, np.ndarray, Tensor, Pwc, Stf],
    y: Union[float, complex, np.ndarray, Tensor, Pwc, Stf],
    name: str,
    validate_value_shape: Optional[Callable] = validate_broadcasted_shape,
):
    """
...
class ArithmeticBinaryGraph:  # pylint: disable=unused-argument
    ...
    def matmul(
        ...
        *,
        ...
        def validate_value_shape(x_shape, y_shape, x_name, y_name):
